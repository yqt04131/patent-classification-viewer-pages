window.IPC_SHARD_C06D = {
  "generatedAt": "2026-03-20T02:17:46.404Z",
  "total": 11,
  "entries": {
    "C06D": {
      "code": "C06D",
      "level": 0,
      "parent": "C06",
      "ja": "煙または霧の発生用具；ガス弾組成物；爆破または推進用ガスの発生（化学的な部分）［２］",
      "en": "MEANS FOR GENERATING SMOKE OR MIST; GAS-ATTACK COMPOSITIONS; GENERATION OF GAS FOR BLASTING OR PROPULSION (CHEMICAL PART)",
      "count": 71,
    ...
    "C06D3/00": {
      ...
      "level": 0,
      "parent": "C06D",
      "ja": "煙または霧の発生（化学的な部分）（殺生物剤，有害生物忌避剤または誘引剤，または植物生長調節剤として用いられる組成物Ａ０１Ｎ２５／１８）",
      "en": "Generation of smoke or mist [chemical part] (compositions used as biocides, pest repellants or attractants, or plant growth regulators <b>A01N25/18</b>)",
      "count": 905,
      "sourceFile": "ipc_C06D.txt",
      "kind": "ipc"
    },
    "C06D5/00": {
      "code": "C06D5/00",
      "level": 0,
      "parent": "C06D",
      "ja": "圧力ガスの発生，例．薬包爆破用，始動薬包用，ロケット用（酸化剤を含む火薬，空気以外のオキシダントで反応を行うロケットエンジン用燃料Ｃ０６Ｂ）",
      "en": "Generation of pressure gas, e.g. for blasting cartridges, starting cartridges, rockets(explosive compositions containing an oxidizer, fuels for rocket engines intended for reaction with an oxidant other than air <b>C06B</b>)",
      "count": 2360,
      "sourceFile": "ipc_C06D.txt",
      "kind": "ipc"
    },
    "C06D5/02": {
      ...
      "level": 1,
      "parent": "C06D5/00",
      "ja": "圧縮，液化または固体化されたガスの減圧によるもの",
      "en": "by decompressing compressed, liquefied, or solidified gases",
      "count": 54,
      "sourceFile": "ipc_C06D.txt",
      "kind": "ipc"
    },
    "C06D5/04": {
      ...
      "parent": "C06D5/00",
      "ja": "単一物質の自然分解によるもの",
      "en": "by auto-decomposition of single substances",
      "count": 213,
      "sourceFile": "ipc_C06D.txt",
      "kind": "ipc"
    },
    "C06D5/06": {
      ...
      "parent": "C06D5/00",
      "ja": "２以上の固体の反応によるもの",
      "en": "by reaction of two or more solids",
      "count": 1877,
      "sourceFile": "ipc_C06D.txt",
      "kind": "ipc"
    },
    "C06D5/08": {
      ...
      "parent": "C06D5/00",
      "ja": "２以上の液体の反応によるもの",
      "en": "by reaction of two or more liquids",
      "count": 170,
      "sourceFile": "ipc_C06D.txt",
      "kind": "ipc"
    },
    "C06D5/10": {
      ...
      "parent": "C06D5/00",
      "ja": "固体と液体との反応によるもの",
      "en": "by reaction of solids with liquids",
      "count": 233,
      "sourceFile": "ipc_C06D.txt",
      "kind": "ipc"
    },
    "C06D7/00": {
      ...
      "parent": "C06D",
      "ja": "ガス弾用組成物",
      "en": "Compositions for gas-attacks",
      "count": 228,
      "sourceFile": "ipc_C06D.txt",
      "kind": "ipc"
    }

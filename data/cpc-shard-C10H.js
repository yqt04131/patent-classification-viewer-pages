window.CPC_SHARD_C10H = {
  "generatedAt": "2026-03-20T02:17:57.407Z",
  "total": 57,
  "entries": {
    "C10H": {
      "code": "C10H",
      "level": 5,
      "parent": "C10",
      "ja": "湿式法によるアセチレンの製造｛（アセチレンの精製Ｃ０７Ｃ７／００）｝",
      "en": "PRODUCTION OF ACETYLENE BY WET METHODS {(purification of acetylene C07C7/00)}<br><br><u>WARNING</u><br><br>In this subclass non-limiting references (in the sense of paragraph 39 of the Guide to the IPC) may still be displayed in the scheme.",
      "count": 0,
      "ipcCode": "",
      "coreCode": "",
      "note": "",
    ...
    "C10H1/00": {
      ...
      "level": 7,
      "parent": null,
      "ja": "滴下式，重力式，非自動式の給水器をもつアセチレンガス発生器（弁，コックＦ１６Ｋ）",
      "en": "Acetylene gas generators with dropwise, gravity, non-automatic water feed (valves, cocks F16K)",
      "count": 687,
      "ipcCode": "C10H1/00",
      "coreCode": "C10H1/00",
      "note": "",
      "sourceFile": "cpc_C10H.txt",
      "kind": "cpc"
    },
    "C10H1/02": {
      "code": "C10H1/02",
    ...
    "C10H13/00": {
      ...
      "en": "Acetylene gas generation with combined dipping and drop-by-drop system",
      "count": 204,
      "ipcCode": "C10H13/00",
      "coreCode": "C10H13/00",
      "note": "",

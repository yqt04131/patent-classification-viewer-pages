window.CPC_SHARD_C09G = {
  "generatedAt": "2026-03-20T02:17:57.374Z",
  "total": 14,
  "entries": {
    "C09G": {
      "code": "C09G",
      "level": 5,
      "parent": "C09",
      "ja": "フランスポリッシュ以外のつや出し組成物；スキーワックス",
      "en": "POLISHING COMPOSITIONS (French polish C09F11/00); SKI WAXES",
      "count": 0,
      "ipcCode": "",
      "coreCode": "",
      "note": "",
    ...
    "C09G1/00": {
      ...
      "level": 7,
      "parent": null,
      "ja": "つや出し組成物（フランスポリッシュ　Ｃ０９Ｆ１１／００；　洗浄剤　Ｃ１１Ｄ）",
      "en": "Polishing compositions (French polish C09F11/00; detergents C11D)",
      "count": 381,
      "ipcCode": "C09G1/00",
      "coreCode": "C09G1/00",
      "note": "",
      "sourceFile": "cpc_C09G.txt",
      "kind": "cpc"
    },
    "C09G1/02": {
      "code": "C09G1/02",
      "level": 8,
      "parent": "C09G1/00",
      "ja": "研摩剤または粉砕剤を含むもの　｛研磨剤　Ｃ０９Ｋ３／１４；‐導体の仕上げ　Ｈ０１Ｌ｝　",
      "en": "containing abrasives or grinding agents {(abrasives as such C09K3/14; polishing of semi-conductors H10P52/40)}",
      "count": 6626,
      "ipcCode": "C09G1/02",
      "coreCode": "C09G1/02",
      "note": "",
    ...
    "C09G1/04": {
      ...
      "level": 8,
      "parent": "C09G1/00",
      "ja": "水性分散物　（Ｃ０９Ｇ１／０２が優先）",
      "en": "Aqueous dispersions (C09G1/02 takes precedence)",
      "count": 792,
      "ipcCode": "C09G1/04",
      "coreCode": "C09G1/04",
      "note": "",
    ...
    "C09G1/06": {
      ...
      "parent": "C09G1/00",
      "ja": "他のつや出し組成物",
      "en": "Other polishing compositions",
      "count": 149,
      "ipcCode": "C09G1/06",
      "coreCode": "C09G1/06",
      "note": "",
    ...
    "C09G1/10": {
      ...
      "level": 10,
      "parent": "C09G1/08",
      "ja": "ワックスおよび天然または合成樹脂の混合物を基材とするもの",
      "en": "based on mixtures of wax and natural or synthetic resin",
      "count": 411,
      "ipcCode": "C09G1/10",
      "coreCode": "C09G1/10",
      "note": "",
    ...
    "C09G1/12": {
      ...
      "level": 11,
      "parent": "C09G1/10",
      "ja": "ワックスおよびシリコーン含有重縮合物の混合物",
      "en": "mixtures of wax and silicon-containing polycondensates",
      "count": 288,
      "ipcCode": "C09G1/12",
      "coreCode": "C09G1/12",
      "note": "",
    ...
    "C09G1/14": {
      ...
      "parent": "C09G1/06",
      "ja": "非ワックス性物質を基材とするもの",
      "en": "based on non-waxy substances",
      "count": 154,
      "ipcCode": "C09G1/14",
      "coreCode": "C09G1/14",
      "note": "",
    ...
    "C09G1/16": {
      ...
      "level": 10,
      "parent": "C09G1/14",
      "ja": "天然または合成樹脂を基材とするもの",
      "en": "on natural or synthetic resins",
      "count": 632,
      "ipcCode": "C09G1/16",
      "coreCode": "C09G1/16",
      "note": "",

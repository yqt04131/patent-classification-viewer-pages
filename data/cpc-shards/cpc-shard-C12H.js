window.CPC_SHARD_C12H = {
  "generatedAt": "2026-03-20T02:17:57.459Z",
  "total": 30,
  "entries": {
    "C12H": {
      "code": "C12H",
      "level": 5,
      "parent": "C12",
      "ja": "　低温殺菌；殺菌；保存；精製；清澄；熟成｛特記．　以下のＩＰＣグループはＥＣＬＡ分類表では使用されない。これらのグループに包含される主題事項は，以下の各ＥＣＬＡグループに分類する:Ｃ１２Ｈ１／０４４(ＥＣＬＡ)はＣ１２Ｈ１／０４０８に包含。Ｃ１２Ｈ１／０４８(ＥＣＬＡ)はＣ１２Ｈ１／０４０８に包含。Ｃ１２Ｈ１／０５２(ＥＣＬＡ)はＣ１２Ｈ１／０４１６に包含。Ｃ１２Ｈ１／０５６(ＥＣＬＡ)はＣ１２Ｈ１／０４２４に包含。Ｃ１２Ｈ１／０６５(ＥＣＬＡ)はＣ１２Ｈ１／０６１に包含。Ｃ１２Ｈ１／０７(ＥＣＬＡ)はＣ１２Ｈ１／０６３に包含。Ｃ１２Ｈ１／０７５(ＥＣＬＡ)はＣ１２Ｈ１／０６３に包含。Ｃ１２Ｈ１／１５(ＥＣＬＡ)はＣ１２Ｈ１／００３に包含。Ｃ１２Ｈ３／００(ＥＣＬＡ)はＣ１２Ｇ３／０８に包含。Ｃ１２Ｈ３／０２(ＥＣＬＡ)はＣ１２Ｇ３／１２に包含。Ｃ１２Ｈ３／０４(ＥＣＬＡ)はＣ１２Ｇ３／０８５に包含。｝注．｛ＩＰＣ８｝このグループに分類する場合，クロマトグラフィーに関する一般的な主題事項に関する限りグループＢ０１Ｄ１５／０８にも分類する。",
      "en": "PASTEURISATION, STERILISATION, PRESERVATION, PURIFICATION, CLARIFICATION OR AGEING OF ALCOHOLIC BEVERAGES; METHODS FOR ALTERING THE ALCOHOL CONTENT OF FERMENTED SOLUTIONS OR ALCOHOLIC BEVERAGES (simulation ageing by flavouring C12G3/06)<br><br><u>NOTE</u><br><br> When classifying in this subclass, classification is also made in group B01D15/08 insofar as subject matter of general interest relating to chromatography is concerned. <br><br><u>WARNING</u><br>The following IPC groups are not in the CPC scheme. The subject matter for these IPC groups is classified in the following CPC groups: C12H1/044 -  C12H1/048 covered by C12H1/0408C12H1/052 covered by C12H1/0416C12H1/056 covered by C12H1/0424C12H1/065 covered by C12H1/061C12H1/07 &#8211; C12H1/075 covered by C12H1/063C12H1/15 covered by C12H1/003",
      "count": 0,
      "ipcCode": "",
      "coreCode": "",
      "note": "",
    ...
    "C12H1/00": {
      ...
      "level": 7,
      "parent": null,
      "ja": "アルコール飲料の低温殺菌，殺菌，保存，精製，清澄または熟成（加香による模擬熟成Ｃ１２Ｇ３／０６）",
      "en": "Pasteurisation, sterilisation, preservation, purification, clarification, or ageing of alcoholic beverages (simulating ageing by flavouring C12G3/06)",
      "count": 435,
      "ipcCode": "C12H1/00",
      "coreCode": "C12H1/00",
      "note": "",
      "sourceFile": "cpc_C12H.txt",
      "kind": "cpc"
    },
    "C12H1/003": {
      "code": "C12H1/003",
    ...
    "C12H1/0408": {
      ...
      "parent": "C12H1/04",
      "ja": "｛無機添加物の補助手段をもつもの｝",
      "en": "{with the aid of inorganic added material}",
      "count": 926,
      "ipcCode": "C12H1/044",
      "coreCode": "C12H1/04",
      "note": "",
    ...
    "C12H1/0416": {
      ...
      "parent": "C12H1/04",
      "ja": "｛有機添加物の補助手段をもつもの｝",
      "en": "{with the aid of organic added material}",
      "count": 326,
      "ipcCode": "C12H1/052",
      "coreCode": "C12H1/04",
      "note": "",
    ...
    "C12H1/0432": {
      ...
      "level": 10,
      "parent": "C12H1/04",
      "ja": "｛イオン交換物質の補助手段をもつもの｝",
      "en": "{with the aid of ion-exchange material}",
      "count": 108,
      "ipcCode": "C12H1/04",
      "coreCode": "C12H1/04",
      "note": "",
    ...
    "C12H3/00": {
      ...
      "parent": null,
      "ja": "",
      "en": "Methods for reducing the alcohol content of fermented solutions or alcoholic beverage to obtain low alcohol or non-alcoholic beverages",
      "count": 143,
      "ipcCode": "C12H3/00",
      "coreCode": "C12H3/00",
      "note": "",

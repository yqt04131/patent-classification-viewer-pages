window.CPC_SHARD_C22F = {
  "generatedAt": "2026-03-20T02:17:57.558Z",
  "total": 28,
  "entries": {
    "C22F": {
      "code": "C22F",
      "level": 5,
      "parent": "C22",
      "ja": "非鉄金属および非鉄合金の物理的構造の変換（少なくとも１方法はクラスＣ２３に分類されかつ少なくとも１方法はこのサブクラスに包含される金属質材料の表面処理，Ｃ２３Ｆ１７／００）",
      "en": "CHANGING THE PHYSICAL STRUCTURE OF NON-FERROUS METALS AND NON-FERROUS ALLOYS (surface treatment of metallic material involving at least one process provided for in class C23 and at least one process covered by this subclass, C23F17/00)<br><br><u>WARNING</u><br><br>In this subclass non-limiting references (in the sense of paragraph 39 of the Guide to the IPC) may still be displayed in the scheme.",
      "count": 0,
      "ipcCode": "",
      "coreCode": "",
      "note": "",
    ...
    "C22F1/00": {
      ...
      "level": 7,
      "parent": null,
      "ja": "非鉄金属または合金の熱処理によるか熱間または冷間加工による物理的構造の変化（金属の機械加工用装置Ｂ２１，Ｂ２３，Ｂ２４）",
      "en": "Changing the physical structure of non-ferrous metals or alloys by heat treatment or by hot or cold working (apparatus for mechanical working of metal B21, B23, B24)",
      "count": 2797,
      "ipcCode": "C22F1/00",
      "coreCode": "C22F1/00",
      "note": "",
      "sourceFile": "cpc_C22F.txt",
      "kind": "cpc"
    },
    "C22F1/002": {
      "code": "C22F1/002",
      "level": 8,
      "parent": "C22F1/00",
      "ja": "｛急速冷却または焼入れによるもの；　そのために用いる冷却剤｝",
      "en": "{by rapid cooling or quenching; cooling agents used therefor}",
      "count": 5680,
      "ipcCode": "C22F1/00",
      "coreCode": "C22F1/00",
      "note": "",
    ...
    "C22F1/004": {
      ...
      "parent": "C22F1/00",
      "ja": "｛流動床での熱処理｝",
      "en": "{Heat treatment in fluid bed}",
      "count": 15,
      "ipcCode": "C22F1/00",
      "coreCode": "C22F1/00",
      "note": "",
    ...
    "C22F1/006": {
      ...
      "level": 8,
      "parent": "C22F1/00",
      "ja": "｛記憶作用により熱回復可能な合金が得られるもの｝",
      "en": "{Resulting in heat recoverable alloys with a memory effect}",
      "count": 675,
      "ipcCode": "C22F1/00",
      "coreCode": "C22F1/00",
      "note": "",
    ...
    "C22F1/008": {
      ...
      "parent": "C22F1/00",
      "ja": "｛保護表面層を用いるもの｝",
      "en": "{Using a protective surface layer}",
      "count": 193,
      "ipcCode": "C22F1/00",
      "coreCode": "C22F1/00",
      "note": "",
    ...
    "C22F1/02": {
      ...
      "level": 8,
      "parent": "C22F1/00",
      "ja": "不活性ガスまたは制御雰囲気または真空中で行なうもの（雰囲気組成の調整Ｃ２１Ｄ１／７６）",
      "en": "in inert or controlled atmosphere or vacuum (adjusting the composition of the atmosphere C21D1/76)",
      "count": 3710,
      "ipcCode": "C22F1/02",
      "coreCode": "C22F1/02",
      "note": "",
    ...
    "C22F1/05": {
      ...
      "level": 9,
      "parent": "C22F1/04",
      "ja": "Ａｌ―Ｓｉ―Ｍｇ型合金，すなわち．けい素およびマグネシウムをほぼ同じ割合で含有する合金",
    ...
    "C22F1/16": {
      ...
      "level": 8,
      "parent": "C22F1/00",
      "ja": "上記以外の金属またはそれを基とする合金．｛注．．このグループにおいては，＋ＩＤＴという表現は以下の内容を意味する。．　－　ここに分類されている文献は，熱処理による半導体材料の特性の改良に関連するＩＤＴ－グループに分類されていた。．　－　それらは，管理上，該　ＩＤＴ－グループからこのグループに再分類された。｝",
    ...
    "C22F1/165": {
      ...
      "level": 9,
      "parent": "C22F1/16",
      "ja": "｛亜鉛またはカドミウムまたはそれらに基づく合金の｝",
      "en": "{of zinc or cadmium or alloys based thereon}",
      "count": 429,
      "ipcCode": "C22F1/16",
      "coreCode": "C22F1/16",
      "note": "",
    ...
    "C22F1/183": {
      ...
      "parent": "C22F1/18",
      "ja": "｛チタンまたはそれに基づく合金の｝",
      "en": "{of titanium or alloys based thereon}",
      "count": 4534,
      "ipcCode": "C22F1/18",
      "coreCode": "C22F1/18",
      "note": "",
    ...
    "C22F1/186": {
      ...
      "level": 10,
      "parent": "C22F1/18",
      "ja": "｛ジルコニウムまたはそれに基づく合金の｝",
      "en": "{of zirconium or alloys based thereon}",
      "count": 645,
      "ipcCode": "C22F1/18",
      "coreCode": "C22F1/18",
      "note": "",
    ...
    "C22F3/00": {
      ...
      "level": 7,
      "parent": null,
      "ja": "特殊な物理的方法，例．中性子処理，による非鉄金属または合金の物理的構造の変化｛注．このグループにおいては，＋ＩＤＴという表現は以下の内容を意味する。　－　ここに分類されている文献は，超高圧，波または電磁場で用いられる金属または合金の特性の改良に関連するＩＤＴ－グループに分類されていた。　－　それらは，管理上，該　ＩＤＴ－グループからこのグループに再分類された。｝",

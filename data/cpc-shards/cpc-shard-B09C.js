window.CPC_SHARD_B09C = {
  "generatedAt": "2026-03-20T02:17:56.389Z",
  "total": 18,
  "entries": {
    "B09C": {
      "code": "B09C",
      "level": 5,
      "parent": "B09",
      "ja": "汚染土壌の再生（土壌から石などを取り除いて集める機械Ａ０１Ｂ４３／００；蒸気土壌殺菌Ａ０１Ｇ１１／００；廃物などの好ましくないものの地面からの除去Ｅ０１Ｈ１５／００）<br><br><u>注</u><br><br>このサブクラスにおいては，下記の用語は以下に示す意味で用いる：<br>－再生とは，土壌中の汚染物質の部分的あるいは全面的除去，もしくは固定を意味する。<br><br><u>警告</u><br>　以下のＩＰＣグループはＣＰＣ分類表にはない。これらのグループに分類される主題事項は，以下の各ＣＰＣグループに分類する：<br>　Ｂ０９Ｃ１／０４ は Ｂ０９Ｃ１／０２ に包含される",
      "en": "RECLAMATION OF CONTAMINATED SOIL (gatherers for removing stone or the like from the soil A01B43/00; sterilising soil by steam A01G11/00; removing undesirable matter, e.g. rubbish, from the land E01H15/00)<br><br><u>NOTE</u><br><br> In this subclass, the following term is used with the meaning indicated: <br>\"reclamation\" means the partial or total elimination  or the fixing of contaminants in soil. <br><br><u>WARNING</u><br>The following IPC groups are not in the CPC scheme. The subject matter for these IPC groups is classified in the following CPC groups:B09C1/04 covered by B09C1/02",
      "count": 0,
      "ipcCode": "",
      "coreCode": "",
      "note": "",
    ...
    "B09C1/002": {
      ...
      "parent": "B09C1/00",
      "ja": "｛その場での地下水処理を含むもの｝",
      "en": "{involving in-situ ground water treatment}",
      "count": 1903,
      "ipcCode": "B09C1/00",
      "coreCode": "B09C1/00",
      "note": "",
    ...
    "B09C1/005": {
      ...
      "level": 8,
      "parent": "B09C1/00",
      "ja": "｛負圧または通気を使った蒸気または気体の抽出｝",
      "en": "{Extraction of vapours or gases using vacuum or venting}",
      "count": 631,
      "ipcCode": "B09C1/00",
      "coreCode": "B09C1/00",
      "note": "",
    ...
    "B09C1/007": {
      ...
      "level": 8,
      "parent": "B09C1/00",
      "ja": "｛水のテーブル上に浮いている汚染物を除去することによるもの｝",
      "en": "{by removing contaminants floating on the water table}",
      "count": 68,
      "ipcCode": "B09C1/00",
      "coreCode": "B09C1/00",
      "note": "",
    ...
    "B09C1/02": {
      ...
      "level": 8,
      "parent": "B09C1/00",
      "ja": "液体を使った抽出，例．洗浄，溶脱，｛浮遊選別｝",
      "en": "Extraction using liquids, e.g. washing, leaching {, flotation}",
      "count": 2788,
      "ipcCode": "B09C1/02",
      "coreCode": "B09C1/02",
      "note": "",
    ...
    "B09C1/025": {
      ...
      "level": 9,
      "parent": "B09C1/02",
      "ja": "｛溶解剤または抽出剤として油を用いるもの｝",
      "en": "{using an oil as solvent or extracting agent}",
      "count": 49,
      "ipcCode": "B09C1/02",
      "coreCode": "B09C1/02",
      "note": "",
    ...
    "B09C1/062": {
      ...
      "level": 9,
      "parent": "B09C1/06",
      "ja": "｛要素を加熱する電極または抵抗を用いるもの｝",
      "en": "{by using electrode or resistance heating elements}",
      "count": 232,
      "ipcCode": "B09C1/06",
      "coreCode": "B09C1/06",
      "note": "",
    ...
    "B09C1/085": {
      ...
      "level": 9,
      "parent": "B09C1/08",
      "ja": "｛電気化学的手段を用いるもの，例．動電学によるもの｝",
      "en": "{electrochemically, e.g. by electrokinetics}",
      "count": 957,
      "ipcCode": "B09C1/08",
      "coreCode": "B09C1/08",
      "note": "",
    ...
    "B09C1/10": {
      ...
      "level": 8,
      "parent": "B09C1/00",
      "ja": "微生物学的な手段，｛生物学的な手段｝あるいは酵素を利用するもの",
      "en": "microbiologically, {biologically} or by using enzymes",
      "count": 5703,
      "ipcCode": "B09C1/10",
      "coreCode": "B09C1/10",
      "note": "",

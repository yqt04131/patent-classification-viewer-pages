window.CPC_SHARD_C25C = {
  "generatedAt": "2026-03-20T02:17:57.577Z",
  "total": 49,
  "entries": {
    "C25C": {
      "code": "C25C",
      "level": 5,
      "parent": "C25",
      "ja": "金属の電解製造，回収または精製方法；そのための装置<br><br><u>警告</u><br><br>このサブクラスにおいては（ＩＰＣ指針第３９段落の意味における）非限定参照も分類表において依然として表示される。",
      "en": "PROCESSES FOR THE ELECTROLYTIC PRODUCTION, RECOVERY OR REFINING OF METALS; APPARATUS THEREFOR<br><br><u>WARNING</u><br><br>In this subclass non-limiting references (in the sense of paragraph 39 of the Guide to the IPC) may still be displayed in the scheme.",
      "count": 0,
      "ipcCode": "",
      "coreCode": "",
      "note": "",
    ...
    "C25C1/00": {
      ...
      "level": 7,
      "parent": null,
      "ja": "溶液の電気分解による金属の電解製造，回収または精製（Ｃ２５Ｃ５／００が優先）",
      "en": "Electrolytic production, recovery or refining of metals by electrolysis of solutions (C25C5/00 takes precedence)",
      "count": 614,
      "ipcCode": "C25C1/00",
      "coreCode": "C25C1/00",
      "note": "",
      "sourceFile": "cpc_C25C.txt",
      "kind": "cpc"
    },
    "C25C1/02": {
      "code": "C25C1/02",
    ...
    "C25C1/06": {
      ...
      "level": 8,
      "parent": "C25C1/00",
      "ja": "または鉄族金属，耐火金属またはマンガン",
      "en": "or iron group metals, refractory metals or manganese",
      "count": 435,
      "ipcCode": "C25C1/06",
      "coreCode": "C25C1/06",
      "note": "",
    ...
    "C25C1/22": {
      ...
      "level": 8,
      "parent": "C25C1/00",
      "ja": "グループＣ２５Ｃ１／０２～Ｃ２５Ｃ１／２０に分類されない金属",
      "en": "of metals not provided for in groups C25C1/02&#160;-&#160;C25C1/20",
      "count": 641,
      "ipcCode": "C25C1/22",
      "coreCode": "C25C1/22",
      "note": "",
    ...
    "C25C1/24": {
      ...
      "level": 8,
      "parent": "C25C1/00",
      "ja": "全てのイオンの陰極還元によって得られる合金",
      "en": "Alloys obtained by cathodic reduction of all their ions",
      "count": 149,
      "ipcCode": "C25C1/24",
      "coreCode": "C25C1/24",
      "note": "",
    ...
    "C25C3/00": {
      ...
      "level": 7,
      "parent": null,
      "ja": "溶融物の電気分解による金属の電解製造，回収または精製（Ｃ２５Ｃ５／００が優先）",
      "en": "Electrolytic production, recovery or refining of metals by electrolysis of melts (C25C5/00 takes precedence)",
      "count": 394,
      "ipcCode": "C25C3/00",
      "coreCode": "C25C3/00",
      "note": "",
    ...
    "C25C3/08": {
      ...
      "level": 9,
      "parent": "C25C3/06",
      "ja": "電解槽の構造，例．底部，壁部，陰極",
      "en": "Cell construction, e.g. bottoms, walls, cathodes",
      "count": 1554,
      "ipcCode": "C25C3/08",
      "coreCode": "C25C3/08",
      "note": "",
    ...
    "C25C3/085": {
      ...
      "parent": "C25C3/08",
      "ja": "｛非導電熱絶縁部に特徴があるもの｝",
      "en": "{characterised by its non electrically conducting heat insulating parts}",
      "count": 188,
      "ipcCode": "C25C3/08",
      "coreCode": "C25C3/08",
      "note": "",
    ...
    "C25C3/14": {
      ...
      "parent": "C25C3/06",
      "ja": "供給用または金属皮破砕用装置",
      "en": "Devices for feeding or crust breaking",
      "count": 544,
      "ipcCode": "C25C3/14",
      "coreCode": "C25C3/14",
      "note": "",
    ...
    "C25C3/16": {
      ...
      "parent": "C25C3/06",
      "ja": "電流供給装置，例．母線",
      "en": "Electric current supply devices, e.g. bus bars",
      "count": 740,
      "ipcCode": "C25C3/16",
      "coreCode": "C25C3/16",
      "note": "",
    ...
    "C25C3/20": {
      ...
      "level": 9,
      "parent": "C25C3/06",
      "ja": "電解槽の自動制御または自動調製（制御または調製一般Ｇ０５）",
      "en": "Automatic control or regulation of cells (controlling or regulating in general G05)",
      "count": 817,
      "ipcCode": "C25C3/20",
      "coreCode": "C25C3/20",
      "note": "",
    ...
    "C25C3/26": {
      ...
      "level": 8,
      "parent": "C25C3/00",
      "ja": "チタン，ジルコニウム，ハフニウム，タンタルまたはバナジウム",
      "en": "of titanium, zirconium, hafnium, tantalum or vanadium",
      "count": 275,
      "ipcCode": "C25C3/26",
      "coreCode": "C25C3/26",
      "note": "",
    ...
    "C25C3/34": {
      ...
      "level": 8,
      "parent": "C25C3/00",
      "ja": "グループＣ２５Ｃ３／０２～Ｃ２５Ｃ３／３２に分類されない金属",
      "en": "of metals not provided for in groups C25C3/02&#160;-&#160;C25C3/32",
      "count": 1118,
      "ipcCode": "C25C3/34",
      "coreCode": "C25C3/34",
      "note": "",
    ...
    "C25C5/00": {
      ...
      "level": 7,
      "parent": null,
      "ja": "金属粉または多孔質金属塊の電解製造，回収または精製",
      "en": "Electrolytic production, recovery or refining of metal powders or porous metal masses",
      "count": 76,
      "ipcCode": "C25C5/00",
      "coreCode": "C25C5/00",
      "note": "",
    ...
    "C25C7/00": {
      ...
      "level": 7,
      "parent": null,
      "ja": "電解槽の構造部品またはその組立体；電解槽の保守または操作（アルミニウムの製造のためのものＣ２５Ｃ３／０６～Ｃ２５Ｃ３／２２）",
      "en": "Constructional parts, or assemblies thereof, of cells; Servicing or operating of cells (for the production of aluminium C25C3/06&#160;-&#160;C25C3/22)",
      "count": 1913,
      "ipcCode": "C25C7/00",
      "coreCode": "C25C7/00",
      "note": "",
    ...
    "C25C7/002": {
      ...
      "level": 8,
      "parent": "C25C7/00",
      "ja": "｛少なくとも１つの粒子で作られた電極からなる電解層の（Ｃ２５Ｃ７／００５，Ｃ２５Ｃ７／０２～Ｃ２５Ｃ７／０６が優先）｝",
      "en": "{of cells comprising at least an electrode made of particles (C25C7/005, C25C7/02&#160;-&#160;C25C7/06 take precedence)}",
      "count": 120,
      "ipcCode": "C25C7/00",
      "coreCode": "C25C7/00",
      "note": "",
    ...
    "C25C7/005": {
      ...
      "level": 8,
      "parent": "C25C7/00",
      "ja": "｛溶融物の電解のための電解槽の（Ｃ２５Ｃ７／０２～Ｃ２５Ｃ７／０６が優先）｝",
      "en": "{of cells for the electrolysis of melts (C25C7/02&#160;-&#160;C25C7/06 take precedence)}",
      "count": 1024,
      "ipcCode": "C25C7/00",
      "coreCode": "C25C7/00",
      "note": "",
    ...
    "C25C7/007": {
      ...
      "level": 8,
      "parent": "C25C7/00",
      "ja": "｛少なくとも１つの可動電極からなる電解層の（Ｃ２５Ｃ７／００２，Ｃ２５Ｃ７／０２～Ｃ２５Ｃ７／０６が優先）｝",
      "en": "{of cells comprising at least a movable electrode (C25C7/002, C25C7/02&#160;-&#160;C25C7/06 take precedence)}",
      "count": 189,
      "ipcCode": "C25C7/00",
      "coreCode": "C25C7/00",
      "note": "",
    ...
    "C25C7/02": {
      ...
      "level": 8,
      "parent": "C25C7/00",
      "ja": "電極（金属の精製用消耗電極Ｃ２５Ｃ１／００～Ｃ２５Ｃ５／００）；電極の接続具",
      "en": "Electrodes (consumable anodes for the refining the metals C25C1/00&#160;-&#160;C25C5/00); Connections thereof",
      "count": 2235,
      "ipcCode": "C25C7/02",
      "coreCode": "C25C7/02",
      "note": "",
    ...
    "C25C7/025": {
      ...
      "level": 9,
      "parent": "C25C7/02",
      "ja": "｛溶融物の電解のために電解槽内で用いられるもの｝",
      "en": "{used in cells for the electrolysis of melts}",
      "count": 782,
      "ipcCode": "C25C7/02",
      "coreCode": "C25C7/02",
      "note": "",
    ...
    "C25C7/08": {
      ...
      "parent": "C25C7/06",
      "ja": "陰極からの析出金属の分離",
      "en": "Separating of deposited metals from the cathode",
      "count": 591,
      "ipcCode": "C25C7/08",
      "coreCode": "C25C7/08",
      "note": "",

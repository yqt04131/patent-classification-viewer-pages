window.CPC_SHARD_B62C = {
  "generatedAt": "2026-03-20T02:17:56.846Z",
  "total": 22,
  "entries": {
    "B62C": {
      "code": "B62C",
      "level": 5,
      "parent": "B62",
      "ja": "　畜力牽引運搬車注．このサブクラスは運搬車及びその部分が畜力牽引運搬車に関連した特徴をもつ限りにおいてのみ包含する；　もしそのような特徴が無ければ，畜力牽引運搬車は　Ｂ６２Ｄ又はＢ６０で取り扱われるトレーラ又はＢ６２Ｂで取り扱われるそりと見なす。",
      "en": "VEHICLES DRAWN BY ANIMALS<br><br><u>NOTE</u><br><br>This subclass covers only vehicles or parts thereof in so far as the relevant features are essential for animal-drawn vehicles.<br>This subclass does not cover animal-drawn vehicles which have not the features mentioned in Note (1) above. They are regarded as trailers which are covered by class  B60 or subclass B62D, or as sledges which are covered by subclass B62B.<br><br><u>WARNING</u><br><br>In this subclass non-limiting references (in the sense of paragraph 39 of the Guide to the IPC) may still be displayed in the scheme.",
      "count": 0,
      "ipcCode": "",
      "coreCode": "",
      "note": "",
    ...
    "B62C3/00": {
      ...
      "level": 7,
      "parent": null,
      "ja": "運搬車の下部構造または走行装置；車軸支持（農機具または装置を支持する下部構造　Ａ０１Ｂ３５／３０，Ａ０１Ｂ３９／２４；５Ａ０１Ｂ５１／００）",
      "en": "Undercarriages or running gear of vehicles; Axle supports (undercarriages for supporting agricultural tools or apparatus A01B35/30, A01B39/24, A01B51/00)",
      "count": 95,
      "ipcCode": "B62C3/00",
      "coreCode": "B62C3/00",
      "note": "",
    ...
    "B62C5/00": {
      ...
      "en": "Draught assemblies (traction harness B68B3/00)",
      "count": 2159,
      "ipcCode": "B62C5/00",
      "coreCode": "B62C5/00",
      "note": "",
    ...
    "B62C7/00": {
      ...
      "level": 7,
      "parent": null,
      "ja": "畜力牽引運搬車独特の制動機構と制動制御装置　（制動一般Ｆ１６Ｄ）",
      "en": "Braking mechanisms and brake control devices specially adapted for animal-drawn vehicles (brakes in general F16D)",
      "count": 27,
      "ipcCode": "B62C7/00",
      "coreCode": "B62C7/00",
      "note": "",
    ...
    "B62C9/00": {
      ...
      "en": "Carriers or holders for whips; Holders for reins forming part of or attached to vehicles (reins or whips per seB68B)",
      "count": 856,
      "ipcCode": "B62C9/00",
      "coreCode": "B62C9/00",
      "note": "",

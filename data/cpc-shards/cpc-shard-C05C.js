window.CPC_SHARD_C05C = {
  "generatedAt": "2026-03-20T02:17:57.230Z",
  "total": 17,
  "entries": {
    "C05C": {
      "code": "C05C",
      "level": 5,
      "parent": "C05",
      "ja": "　窒素肥料｛特記．　ＩＰＣグループＣ０５Ｃ１３／００(ＥＣＬＡ)は，内部ＥＣＬＡ分類表には使用されない。このグループに包含される主題事項は，ＥＣＬＡグループＣ０５Ｃ１／００からＣ０５Ｃ１１／００のひとつに分類される。（クラスＣ０５のタイトルの後の内部注．を参照）｝",
      "en": "NITROGENOUS FERTILISERS<br><br><u>WARNING</u><br>The following IPC groups are not in the CPC scheme. The subject matter for these IPC groups is classified in the following CPC groups: C05C13/00covered byC05C1/00 - C05C11/00 (see internal note after the title of class C05)",
      "count": 0,
      "ipcCode": "",
      "coreCode": "",
      "note": "",
    ...
    "C05C1/02": {
      ...
      "level": 8,
      "parent": "C05C1/00",
      "ja": "粒状化（装置Ｂ０１Ｊ２／００）；ペレット化；安定化；着色",
      "en": "Granulation (apparatus B01J2/00); Pelletisation; Stabilisation; Colouring",
      "count": 765,
      "ipcCode": "C05C1/02",
      "coreCode": "C05C1/02",
      "note": "",
    ...
    "C05C7/02": {
      ...
      "level": 8,
      "parent": "C05C7/00",
      "ja": "粒状化（装置Ｂ０１Ｊ２／００）；ペレット化；脱ガス；水和；硬化；安定化；オイル処理",
      "en": "Granulation (apparatus B01J2/00); Pelletisation; Degassing; Hydrating; Hardening; Stabilisation; Oiling",
      "count": 219,
      "ipcCode": "C05C7/02",
      "coreCode": "C05C7/02",
      "note": "",

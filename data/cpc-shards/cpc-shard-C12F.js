window.CPC_SHARD_C12F = {
  "generatedAt": "2026-03-20T02:17:57.452Z",
  "total": 10,
  "entries": {
    "C12F": {
      "code": "C12F",
      "level": 5,
      "parent": "C12",
      "ja": "発酵液の蒸留または精留；副産物の採取；アルコールの変性または変性アルコール｛特記．下記のグループは，以下に示す日付をもって本分類表から削除した。これらのグループに属する特許文献は，以下に示す新設グループに移動した。Ｃ１２Ｆ１／００(ＥＣＬＡ)→Ｂ０１Ｄ３／００１（２００２年８月）Ｃ１２Ｆ１／０２(ＥＣＬＡ)→Ｂ０１Ｄ３／００２（２００２年８月）Ｃ１２Ｆ１／０４(ＥＣＬＡ)→Ｂ０１Ｄ３／００３（２００２年８月）Ｃ１２Ｆ１／０６(ＥＣＬＡ)→Ｂ０１Ｄ３／００４（２００２年８月）Ｃ１２Ｆ１／０８(ＥＣＬＡ)→Ｂ０１Ｄ３／００５（２００２年８月）",
      "en": "RECOVERY OF BY-PRODUCTS OF FERMENTED SOLUTIONS (removal of yeast from wine or sparkling wine C12G1/08); DENATURED ALCOHOL; PREPARATION THEREOF",
      "count": 0,
      "ipcCode": "",
      "coreCode": "",
      "note": "",
    ...
    "C12F3/06": {
      ...
      "level": 8,
      "parent": "C12F3/00",
      "ja": "ビール及びぶどう酒からのもの（Ｃ１２Ｆ３／０２が優先；酵母の除去Ｃ１２Ｇ１／０８）",
      "en": "from beer and wine (C12F3/02 takes precedence; removal of yeast C12G1/08)",
      "count": 324,
      "ipcCode": "C12F3/06",
      "coreCode": "C12F3/06",
      "note": "",
    ...
    "C12F3/08": {
      ...
      "en": "Recovery of alcohol from press residues or other waste material (from carbon dioxide C12F3/04)",
      "count": 72,
      "ipcCode": "C12F3/08",
      "coreCode": "C12F3/08",
      "note": "",

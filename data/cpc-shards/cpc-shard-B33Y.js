window.CPC_SHARD_B33Y = {
  "generatedAt": "2026-03-20T02:17:56.642Z",
  "total": 14,
  "entries": {
    "B33Y": {
      "code": "B33Y",
      "level": 5,
      "parent": "B33",
      "ja": "付加製造，すなわち付加堆積，付加凝集または付加積層による３次元［３Ｄ］物質の製造，例．３Ｄ印刷による，ステレオリソグラフィーによるまたは選択的レーザー焼結によるもの<br><br><u>注</u><br><br>（１）このサブクラスは付加製造を包含し，工程または使用材料の如何を問わない。<br>（２）このサブクラスは，このサブクラスの分類記号と他のサブクラスからの分類記号とを組み合わせることにより，付加製造に関連する主題事項の包括的なサーチを可能とすることを意図している。したがって，このサブクラスは，ＣＰＣの他の場所にも完全にまたは部分的に包含されているかもしれない付加製造（例．３Ｄ印刷）の特徴を包含する。<br>（３）このサブクラスは他の分類箇所中の該当箇所に既に分類されている主題事項が付加製造の観点を含むときに，その主題事項を，義務的に補足的に分類するためのものである。<br>（４）このサブクラスの分類記号は，特許文献に付与されるとき，先頭には記載されない。<br>（５）このサブクラスには，多観点分類が適用される。そのため，このサブクラスの２以上のグループに包含される主題事項の観点は，それらのグループのそれぞれに分類されるべきである。",
      "en": "ADDITIVE MANUFACTURING, i.e. MANUFACTURING OF THREE-DIMENSIONAL [3D] OBJECTS BY ADDITIVE DEPOSITION, ADDITIVE AGGLOMERATION OR ADDITIVE LAYERING, e.g. BY 3D PRINTING, STEREOLITHOGRAPHY OR SELECTIVE LASER SINTERING<br><br><u>NOTE</u><br><br>This subclass is for obligatory secondary classification in the sense of paragraph 107bis of the Guide to the IPC. Therefore, the classification symbols of this subclass are not listed first when assigned to patent documents. Secondary classification symbols may be assigned for either invention information or additional information, as appropriate.<br>This subclass covers additive manufacturing, irrespective of the process or material used.<br>This subclass is intended to enable a comprehensive search of subject matter related to additive manufacturing by combination of classification symbols of this subclass with classification symbols from other subclasses. Therefore, this subclass covers aspects of additive manufacturing (e.g. three-dimensional [3D] printing) that might also be entirely or partially covered elsewhere in the CPC.",
      "count": 0,
      "ipcCode": "",
      "coreCode": "",
      "note": "",
    ...
    "B33": {
      ...
      "parent": "B",
      "ja": "付加製造技術［２０１５．０１］",
      "en": "ADDITIVE MANUFACTURING TECHNOLOGY",
      "count": 0,
      "ipcCode": "",
      "coreCode": "",
      "note": "",
    ...
    "B33Y30/00": {
      ...
      "level": 7,
      "parent": null,
      "ja": "付加製造の装置；それらの詳細またはそれらのための付属品",
    ...
    "B33Y40/00": {
      ...
      "level": 7,
      "parent": null,
      "ja": "予備作業または機器，例．材料取扱のため",
      "en": "Auxiliary operations or equipment, e.g. for material handling",
      "count": 12709,
      "ipcCode": "B33Y40/00",
      "coreCode": "B33Y40/00",
      "note": "",
    ...
    "B33Y70/00": {
      ...
      "parent": null,
      "ja": "付加製造に特別に適合した材料",
      "en": "Materials specially adapted for additive manufacturing",
      "count": 15580,
      "ipcCode": "B33Y70/00",
      "coreCode": "B33Y70/00",
      "note": "",
    ...
    "B33Y80/00": {
      ...
      "parent": null,
      "ja": "付加製造により製造された製品",
      "en": "Products made by additive manufacturing",
      "count": 24827,
      "ipcCode": "B33Y80/00",
      "coreCode": "B33Y80/00",
      "note": "",

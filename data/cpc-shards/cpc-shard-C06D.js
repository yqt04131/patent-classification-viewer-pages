window.CPC_SHARD_C06D = {
  "generatedAt": "2026-03-20T02:17:57.249Z",
  "total": 11,
  "entries": {
    "C06D": {
      "code": "C06D",
      "level": 5,
      "parent": "C06",
      "ja": "煙または霧の発生用具；ガス弾組成物；爆破または推進用ガスの発生（化学的な部分）（燃料Ｃ１０）",
      "en": "MEANS FOR GENERATING SMOKE OR MIST; GAS-ATTACK COMPOSITIONS; GENERATION OF GAS FOR BLASTING OR PROPULSION (CHEMICAL PART) (fuels C10)<br><br><u>WARNING</u><br><br>In this subclass non-limiting references (in the sense of paragraph 39 of the Guide to the IPC) may still be displayed in the scheme.",
      "count": 0,
      "ipcCode": "",
      "coreCode": "",
      "note": "",
    ...
    "C06D3/00": {
      ...
      "level": 7,
      "parent": null,
      "ja": "煙または霧の発生（化学的な部分）（殺生物剤，有害生物忌避剤または誘引剤，または植物生長調節剤として用いられる組成物Ａ０１Ｎ，例．Ａ０１Ｎ２５／１８）",
      "en": "Generation of smoke or mist (chemical part) (compositions used as biocides, pest repellants or attractants, or plant growth regulators A01N25/18)",
      "count": 577,
      "ipcCode": "C06D3/00",
      "coreCode": "C06D3/00",
      "note": "",
      "sourceFile": "cpc_C06D.txt",
      "kind": "cpc"
    },
    "C06D5/00": {
      "code": "C06D5/00",
      ...
      "en": "Generation of pressure gas, e.g. for blasting cartridges, starting cartridges, rockets (explosive compositions containing an oxidizer, fuels for rocket engines intended for reaction with an oxidant other than air C06B)",
      "count": 660,
      "ipcCode": "C06D5/00",
      "coreCode": "C06D5/00",
      "note": "",

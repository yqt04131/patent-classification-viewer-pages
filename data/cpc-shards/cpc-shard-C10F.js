window.CPC_SHARD_C10F = {
  "generatedAt": "2026-03-20T02:17:57.400Z",
  "total": 12,
  "entries": {
    "C10F": {
      "code": "C10F",
      ...
      "parent": "C10",
      "ja": "でい炭の乾燥または処理",
      "en": "DRYING OR WORKING-UP OF PEAT<br><br><u>WARNING</u><br><br>In this subclass non-limiting references (in the sense of paragraph 39 of the Guide to the IPC) may still be displayed in the scheme.",
      "count": 0,
      "ipcCode": "",
      "coreCode": "",
      "note": "",
    ...
    "C10F5/00": {
      ...
      "level": 7,
      "parent": null,
      "ja": "でい炭の乾燥または脱水（乾燥一般Ｆ２６Ｂ）",
      "en": "Drying or de-watering peat (drying in general F26B)",
      "count": 571,
      "ipcCode": "C10F5/00",
      "coreCode": "C10F5/00",
      "note": "",
      "sourceFile": "cpc_C10F.txt",
      "kind": "cpc"
    },
    "C10F5/02": {
      "code": "C10F5/02",
    ...
    "C10F5/04": {
      ...
      "level": 8,
      "parent": "C10F5/00",
      "ja": "プレス，ハンドプレス，ローラまたは遠心分離器の使用によるもの（成形Ｃ１０Ｆ７／０４）",
      "en": "by using presses, handpresses, rolls, or centrifuges (moulding C10F7/04)",
      "count": 164,
      "ipcCode": "C10F5/04",
      "coreCode": "C10F5/04",
      "note": "",
    ...
    "C10F7/02": {
      ...
      "en": "Disintegrating peat (obtaining fibres from peat D01B1/50)",
      "count": 20,
      "ipcCode": "C10F7/02",
      "coreCode": "C10F7/02",
      "note": "",

window.CPC_SHARD_C08H = {
  "generatedAt": "2026-03-20T02:17:57.337Z",
  "total": 11,
  "entries": {
    "C08H": {
      "code": "C08H",
      "level": 5,
      "parent": "C08",
      "ja": "　天然高分子化合物の誘導体（多糖類Ｃ０８Ｂ；天然ゴムＣ０８Ｃ）｛特記１．このサブクラスは，旧分類表（ＩｄＴ）３９Ｂおよび３９Ｇの終了に伴い１９７４年１０月１日に導入された。２．特許文献は，有効期限が満了したＩｄＴ分類表からＩＰＣ分類表へ現在も継続的に再分類されている。３．一般的なＩＰＣーＩＤＴグループのコンコーダンスは以下の通りである:Ｃ０８Ｈ５／００(ＥＣＬＡ)　:　３９Ｇ｝",
      "en": "DERIVATIVES OF NATURAL MACROMOLECULAR COMPOUNDS (polysaccharides C08B; natural rubber C08C; natural resins or their derivatives C09F; bituminous materials C10)<br><br><u>WARNING</u><br>The following IPC groups are not in the CPC scheme. The subject matter for these IPC groups is classified in the following CPC groups: C08H7/00 covered by C08H6/00",
      "count": 0,
      "ipcCode": "",
      "coreCode": "",
      "note": "",
    ...
    "C08H1/00": {
      ...
      "level": 7,
      "parent": null,
      "ja": "たんぱく質から誘導される高分子物質（食品たんぱく質Ａ２３；にかわ，ゼラチンＣ０９Ｈ）",
      "en": "Macromolecular products derived from proteins (food proteins A23; glue, gelatine C09H)",
      "count": 1251,
      "ipcCode": "C08H1/00",
      "coreCode": "C08H1/00",
      "note": "",
      "sourceFile": "cpc_C08H.txt",
      "kind": "cpc"
    },
    "C08H1/02": {
      "code": "C08H1/02",
    ...
    "C08H6/00": {
      ...
      "level": 7,
      "parent": null,
      "ja": "リグニンから誘導される高分子化合物，例．タンニン，フミン酸",
      "en": "{Macromolecular compounds derived from lignin, e.g. tannins, humic acids}<br><br><u>NOTE</u><br><br>Attention is drawn to the following place, which could be of interest for search: <br>Lignin or lignin derivatives, C07G1/00",
      "count": 3428,
      "ipcCode": "C08H7/00",
      "coreCode": "C08H6/00",
      "note": "",
    ...
    "C08H8/00": {
      ...
      "level": 7,
      "parent": null,
      "ja": "リグノセルロース材料から誘導される高分子化合物",
      "en": "Macromolecular compounds derived from lignocellulosic materials {(pretreatment thereof B27N)}",
      "count": 2221,
      "ipcCode": "C08H8/00",
      "coreCode": "C08H8/00",
      "note": "",
    ...
    "C08H99/00": {
      ...
      "en": "Subject matter not provided for in other groups of this subclass {, e.g. flours, kernels}",
      "count": 379,
      "ipcCode": "C08H99/00",
      "coreCode": "C08H99/00",
      "note": "",

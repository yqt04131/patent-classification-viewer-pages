window.IPC_SHARD_G21H = {
  "generatedAt": "2026-03-20T02:17:47.160Z",
  "total": 15,
  "entries": {
    "G21H": {
      "code": "G21H",
      "level": 0,
      "parent": "G21",
      "ja": "放射線源からのエネルギーの取得；放射線源からの放射線の応用で他の分類箇所に包含されないもの；宇宙線の利用（原子核放射線またはＸ線の測定Ｇ０１Ｔ；核融合炉Ｇ２１Ｂ；原子炉Ｇ２１Ｃ；ガス封入物が外部の微粒子放射または構造的にランプと結合した放射能材料によって励起され発光するランプＨ０１Ｊ６５／０４，Ｈ０１Ｊ６５／０６）",
      "en": "OBTAINING ENERGY FROM RADIOACTIVE SOURCES; APPLICATIONS OF RADIATION FROM RADIOACTIVE SOURCES, NOT OTHERWISE PROVIDED FOR; UTILISING COSMIC RADIATION(measurement of nuclear or X-radiation <b>G01T</b>; fusion reactors <b>G21B</b>; nuclear reactors <b>G21C</b>; lamps in which a gas filling is excited to luminescence by external corpuscular radiation or by radioactive material structurally associated with the lamp <b>H01J65/04</b>, <b>H01J65/06</b>)",
      "count": 73,
    ...
    "G21H1/00": {
      ...
      "level": 0,
      "parent": "G21H",
      "ja": "放射線源から電気エネルギーを得るための装置，例．放射性同位元素から得るもの",
      "en": "Arrangements for obtaining electrical energy from radioactive sources, e.g. from radioactive isotopes",
      "count": 421,
      "sourceFile": "ipc_G21H.txt",
      "kind": "ipc"
    },
    "G21H1/02": {
      "code": "G21H1/02",
      ...
      "parent": "G21H1/00",
      "ja": "ベータ線により直接帯電される素子",
      "en": "Cells charged directly by beta radiation",
      "count": 165,
      "sourceFile": "ipc_G21H.txt",
      "kind": "ipc"
    },
    "G21H1/04": {
      ...
      "level": 1,
      "parent": "G21H1/00",
      "ja": "アルファ線，ベータ線，ガンマ線により引き起こされる二次放射線を利用する素子",
      "en": "Cells using secondary emission induced by alpha radiation, beta radiation, or gamma radiation",
      "count": 127,
      "sourceFile": "ipc_G21H.txt",
      "kind": "ipc"
    },
    "G21H1/06": {
      ...
      "level": 1,
      "parent": "G21H1/00",
      "ja": "放射線によって照射される異種半導体接合部を内部に有する素子",
      "en": "Cells wherein radiation is applied to the junction of different semiconductor materials",
      "count": 405,
      "sourceFile": "ipc_G21H.txt",
      "kind": "ipc"
    },
    "G21H1/08": {
      ...
      "level": 1,
      "parent": "G21H1/00",
      "ja": "異なる二つの金属の接合部で放射線がガスをイオン化するような内部構造を有する素子，すなわち接触電位差素子",
      "en": "Cells in which radiation ionises a gas in the presence of a junction of two dissimilar metals, i.e. contact potential-difference cells",
      "count": 25,
      "sourceFile": "ipc_G21H.txt",
      "kind": "ipc"
    },
    "G21H1/10": {
      ...
      "level": 1,
      "parent": "G21H1/00",
      "ja": "放射線が熱電接合または熱電子変換器を加熱する素子［２］",
      "en": "Cells in which radiation heats a thermoelectric junction or a thermionic converter",
      "count": 370,
      "sourceFile": "ipc_G21H.txt",
      "kind": "ipc"
    },
    "G21H1/12": {
      ...
      "level": 1,
      "parent": "G21H1/00",
      "ja": "放射線を光へ，光を光電子作用により電気エネルギーへ変換する素子",
      "en": "Cells using conversion of the radiation into light combined with subsequent photoelectric conversion into electric energy",
      "count": 181,
      "sourceFile": "ipc_G21H.txt",
      "kind": "ipc"
    },
    "G21H3/00": {
      ...
      "level": 0,
      "parent": "G21H",
      "ja": "放射線源からの放射線エネルギーを電気エネルギー以外のエネルギー，例．光，に直接変換する装置",
      "en": "Arrangements for direct conversion of radiation energy from radioactive sources into forms of energy other than electric energy, e.g. light",
      "count": 169,
      "sourceFile": "ipc_G21H.txt",
      "kind": "ipc"
    },
    "G21H3/02": {
      ...
      "level": 1,
      "parent": "G21H3/00",
      "ja": "放射線により物質が励起され発光するもの（ガス封入物もしくはスクリーンまたは被膜が構造的にランプと結合した放射性材料によって励起され発光するランプＨ０１Ｊ６５／００）",
      "en": "in which material is excited to luminesce by the radiation(lamps in which a gas filling or screen or coating is excited to luminesce by radioactive material structurally associated with the lamp <b>H01J65/00</b>)",
      "count": 121,
      "sourceFile": "ipc_G21H.txt",
      "kind": "ipc"
    },
    "G21H5/00": {
      ...
      "level": 0,
      "parent": "G21H",
      "ja": "放射線源からの放射線の応用またはそのための装置で，他の分類箇所に包含されないもの",
      "en": "Applications of radiation from radioactive sources or arrangements therefor, not otherwise provided for",
      "count": 925,
      "sourceFile": "ipc_G21H.txt",
      "kind": "ipc"
    },
    ...
    "G21H7/00": {
      ...
      "parent": "G21H",
      "ja": "宇宙線の効果の利用",
      "en": "Use of effects of cosmic radiation",
      "count": 77,
      "sourceFile": "ipc_G21H.txt",
      "kind": "ipc"
    }

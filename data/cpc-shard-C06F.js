window.CPC_SHARD_C06F = {
  "generatedAt": "2026-03-20T02:17:57.252Z",
  "total": 24,
  "entries": {
    "C06F": {
      "code": "C06F",
      "level": 5,
      "parent": "C06",
      "ja": "　マッチ；マッチの製造｛注．このサブクラスにおいて＋ＩＤＴの表記は以下のものを示すために用いられる:　－ここに分類される文献は，マッチの製造に関連するＩＤＴグループに分類されていた。　－それらは，管理上，前述のＩＤＴグループからこのサブクラスに再分類された。｝",
      "en": "MATCHES; MANUFACTURE OF MATCHES<br><br><u>WARNING</u><br><br>In this subclass non-limiting references (in the sense of paragraph 39 of the Guide to the IPC) may still be displayed in the scheme.",
      "count": 0,
      "ipcCode": "",
      "coreCode": "",
      "note": "",
    ...
    "C06F1/02": {
      ...
      "level": 8,
      "parent": "C06F1/00",
      "ja": "マッチ軸木の切断（他の操作と独立しているものＢ２７Ｌ９／００）",
      "en": "Cutting match splints (independently of other operations B27L9/00)",
      "count": 183,
      "ipcCode": "C06F1/02",
      "coreCode": "C06F1/02",
      "note": "",
    ...
    "C06F1/06": {
      ...
      "level": 8,
      "parent": "C06F1/00",
      "ja": "マッチの浸漬，被覆，含浸または乾燥（浸漬一般または被覆一般Ｂ０５Ｃ，Ｂ０５Ｄ；含浸一般Ｂ２７Ｋ；乾燥一般Ｆ２６Ｂ）",
      "en": "Dipping, coating, impregnating, or drying of matches (dipping or coating in general B05C, B05D; impregnating in general B27K; drying in general F26B)",
      "count": 63,
      "ipcCode": "C06F1/06",
      "coreCode": "C06F1/06",
      "note": "",
    ...
    "C06F1/12": {
      ...
      "parent": "C06F1/00",
      "ja": "箱詰（包装一般Ｂ６５Ｂ）",
      "en": "Filling matches into boxes (packaging in general B65B)",
      "count": 167,
      "ipcCode": "C06F1/12",
      "coreCode": "C06F1/12",
      "note": "",
    ...
    "C06F3/00": {
      ...
      "level": 7,
      "parent": null,
      "ja": "マッチの製造における化学的特徴（発火剤Ｃ０６Ｂ）",
      "en": "Chemical features in the manufacture of matches (ignition compositions C06B)",
      "count": 190,
      "ipcCode": "C06F3/00",
      "coreCode": "C06F3/00",
      "note": "",
    ...
    "C06F5/00": {
      ...
      "en": "Matches (match-books A24F27/12)",
      "count": 155,
      "ipcCode": "C06F5/00",
      "coreCode": "C06F5/00",
      "note": "",

window.CPC_SHARD_B41G = {
  "generatedAt": "2026-03-20T02:17:56.663Z",
  "total": 11,
  "entries": {
    "B41G": {
      "code": "B41G",
      "level": 5,
      "parent": "B41",
      "ja": "金粉印刷，けい線印刷またはふち取り等用の装置；印刷と共に穿孔するための付属装置（穿孔一般Ｂ２６Ｄ；装飾の製造Ｂ４４Ｃ；枚葉紙または巻取紙の排紙に関するものＢ６５Ｈ３５／００；薄い材料の，例．枚葉紙，巻取紙，折りまたは開きＢ６５Ｈ４５／００，Ｂ６５Ｈ４７／００）",
      "en": "APPARATUS FOR BRONZE PRINTING, LINE PRINTING, OR FOR BORDERING OR EDGING SHEETS OR LIKE ARTICLES; AUXILIARY FOR PERFORATING IN CONJUNCTION WITH PRINTING (perforating in general B26D; production of decorations B44C; perforating in conjunction with sheet or web delivery B65H35/00; folding or unfolding thin material, e.g. sheets, webs, B65H45/00, B65H47/00)<br><br><u>WARNING</u><br><br>In this subclass non-limiting references (in the sense of paragraph 39 of the Guide to the IPC) may still be displayed in the scheme.",
      "count": 0,
      "ipcCode": "",
      "coreCode": "",
      "note": "",
    ...
    "B41G1/00": {
      ...
      "level": 7,
      "parent": null,
      "ja": "ブロンズ印刷または類似の操作用装置（装飾用に粒状材料や金属箔の適用Ｂ４４Ｃ１／００）",
      "en": "Apparatus for bronze printing or for like operations (applying granular materials or metallic foils for decorative purposes B44C1/00)",
      "count": 321,
      "ipcCode": "B41G1/00",
      "coreCode": "B41G1/00",
      "note": "",
      "sourceFile": "cpc_B41G.txt",
      "kind": "cpc"
    },
    "B41G1/02": {
      "code": "B41G1/02",
    ...
    "B41G7/00": {
      ...
      "en": "Auxiliary perforating apparatus associated with printing devices (apparatus or machines for carrying-out printing operations combined with operations other than perforating B41F19/00)",
      "count": 224,
      "ipcCode": "B41G7/00",
      "coreCode": "B41G7/00",
      "note": "",

window.IPC_SHARD_C11C = {
  "generatedAt": "2026-03-20T02:17:46.490Z",
  "total": 19,
  "entries": {
    "C11C": {
      "code": "C11C",
      "level": 0,
      "parent": "C11",
      "ja": "脂肪，脂肪油またはろうから得られる脂肪酸；ろうそく；脂肪，脂肪油，または脂肪酸の化学的変成により得られる脂肪，脂肪油または脂肪酸",
      "en": "FATTY ACIDS OBTAINED FROM FATS, OILS OR WAXES; CANDLES; FATS, OILS OR FATTY ACIDS OBTAINED BY CHEMICAL MODIFICATION OF FATS, OILS OR FATTY ACIDS",
      "count": 306,
    ...
    "C11C1/00": {
      ...
      "level": 0,
      "parent": "C11C",
      "ja": "脂肪，脂肪油またはろうからの脂肪酸の製造；脂肪酸の精製（廃棄物質からの脂肪酸の再生Ｃ１１Ｂ１３／００）",
      "en": "Preparation of fatty acids from fats, fatty oils, or waxes; Refining the fatty acids(recovery of fatty acids from waste materials <b>C11B13/00</b>)",
      "count": 915,
      "sourceFile": "ipc_C11C.txt",
      "kind": "ipc"
    },
    "C11C1/02": {
      "code": "C11C1/02",
    ...
    "C11C3/00": {
      ...
      "level": 0,
      "parent": "C11C",
      "ja": "脂肪，脂肪油または脂肪酸の化学的変成により得られる脂肪，脂肪油または脂肪酸，例．オゾン分解による（スルフォン化脂肪または脂肪油Ｃ０７Ｃ３０９／６２；エポキシ化脂肪Ｃ０７Ｄ３０３／４２；加硫油，例．ファクチスＣ０８Ｈ３／００）",
      "en": "Fats, oils or fatty acids obtained by chemical modification of fats, oils or fatty acids, e.g. by ozonolysis(sulfonated fats or oils <b>C07C309/62</b>; epoxidised fats <b>C07D303/42</b>; vulcanised oils, e.g. factice <b>C08H3/00</b>)",
      "count": 4846,
      "sourceFile": "ipc_C11C.txt",
      "kind": "ipc"
    },
    "C11C3/02": {
      ...
      "level": 1,
      "parent": "C11C3/00",
      "ja": "グリセロールによる脂肪酸のエステル化によるもの",
      "en": "by esterification of fatty acids with glycerol",
      "count": 711,
      "sourceFile": "ipc_C11C.txt",
      "kind": "ipc"
    },
    "C11C3/04": {
      ...
      "level": 1,
      "parent": "C11C3/00",
      "ja": "脂肪または脂肪油のエステル化によるもの",
      "en": "by esterification of fats or fatty oils",
      "count": 2111,
      "sourceFile": "ipc_C11C.txt",
      "kind": "ipc"
    },
    ...
    "C11C5/02": {
      ...
      "parent": "C11C5/00",
      "ja": "その製造のための装置",
      "en": "Apparatus for preparation thereof",
      "count": 1561,
      "sourceFile": "ipc_C11C.txt",
      "kind": "ipc"
    }

window.CPC_SHARD_G06D = {
  "generatedAt": "2026-03-20T02:17:58.887Z",
  "total": 13,
  "entries": {
    "G06D": {
      "code": "G06D",
      "level": 5,
      "parent": "G06",
      "ja": "デジタル流体圧計算装置注．このサブクラスは，少なくとも１つの計算機能が液体または気体手段により作動されるすべての装置を包含する",
      "en": "DIGITAL FLUID-PRESSURE COMPUTING DEVICES<br><br><u>NOTE</u><br><br>This subclass includes all devices in which at least one computing function is performed by hydraulic or pneumatic means<br><br><u>WARNING</u><br><br>In this subclass non-limiting references (in the sense of paragraph 39 of the Guide to the IPC) may still be displayed in the scheme.",
      "count": 0,
      "ipcCode": "",
      "coreCode": "",
      "note": "",
    ...
    "G06D1/00": {
      ...
      "level": 7,
      "parent": null,
      "ja": "細部，例．機能要素（個々の論理素子Ｆ１５Ｃ；弁Ｆ１６Ｋ）｛注．このグループにおいては，＋ＩＤＴという表現は以下の内容を意味する。　－ここで分類される文献は，機械的計算手段に関連するＩＤＴ‐グループに分類されていた:　－それらは管理上上記ＩＤＴ‐グループから当該グループへ再分類されたものである｝",
      "en": "Details, e.g. functional units (individual logic elements F15C; valves F16K)",
      "count": 17,
      "ipcCode": "G06D1/00",
      "coreCode": "G06D1/00",
      "note": "",
      "sourceFile": "cpc_G06D.txt",
      "kind": "cpc"
    },
    "G06D1/02": {
      "code": "G06D1/02",

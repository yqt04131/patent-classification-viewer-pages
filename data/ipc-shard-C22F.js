window.IPC_SHARD_C22F = {
  "generatedAt": "2026-03-20T02:17:46.524Z",
  "total": 21,
  "entries": {
    "C22F": {
      "code": "C22F",
      "level": 0,
      "parent": "C22",
      "ja": "非鉄金属または非鉄合金の物理的構造の変化（鉄合金または鋼の熱処理に特有の方法および金属または合金の熱処理用の装置Ｃ２１Ｄ）<br><br><b><ul>注</ul></b><br>少なくとも１工程はクラスＣ２３に分類され，少なくとも１工程はこのサブクラスに包含される方法を含む金属質材料の表面処理は，グループＣ２３Ｆ１７／００に分類する。［２０１２．０１］",
      "en": "CHANGING THE PHYSICAL STRUCTURE OF NON-FERROUS METALS OR NON-FERROUS ALLOYS(processes specific to heat treatment of ferrous alloys or steels and devices for heat treatment of metals or alloys <b>C21D</b>);<br><br><b><u>Note(s)</u></b><br><br><ul><li>Surface treatments of metallic material involving at least one process provided for in class <b>C23</b> and at least one process covered by this subclass are classified in group <b>C23F17/00</b>.</li></ul>",
      "count": 185,
    ...
    "C22F1/00": {
      ...
      "level": 0,
      "parent": "C22F",
      "ja": "非鉄金属または合金の熱処理によるか熱間または冷間加工による物理的構造の変化",
      "en": "Changing the physical structure of non-ferrous metals or alloys by heat treatment or by hot or cold working",
      "count": 19744,
      "sourceFile": "ipc_C22F.txt",
      "kind": "ipc"
    },
    "C22F1/02": {
      "code": "C22F1/02",
      "level": 1,
      "parent": "C22F1/00",
      "ja": "不活性ガスまたは制御雰（ふん）囲気または真空中で行なうもの",
      "en": "in inert or controlled atmosphere or vacuum",
      "count": 5220,
      "sourceFile": "ipc_C22F.txt",
      "kind": "ipc"
    },
    "C22F1/04": {
      ...
      "en": "of aluminium or alloys based thereon",
      "count": 16308,
      "sourceFile": "ipc_C22F.txt",
      "kind": "ipc"
    },
    "C22F1/043": {
      ...
      "level": 2,
      "parent": "C22F1/04",
      "ja": "次に多い成分としてけい素を含む合金［４］",
      "en": "of alloys with silicon as the next major constituent",
      "count": 4583,
      "sourceFile": "ipc_C22F.txt",
      "kind": "ipc"
    },
    "C22F1/047": {
      ...
      "level": 2,
      "parent": "C22F1/04",
      "ja": "次に多い成分としてマグネシウムを含む合金［４］",
      "en": "of alloys with magnesium as the next major constituent",
      "count": 5095,
      "sourceFile": "ipc_C22F.txt",
      "kind": "ipc"
    },
    "C22F1/05": {
      ...
      "level": 2,
      "parent": "C22F1/04",
      "ja": "Ａｌ―Ｓｉ―Ｍｇ型合金，すなわち．けい素およびマグネシウムをほぼ同じ割合で含有する合金［４］",
      "en": "of alloys of the Al-Si-Mg type, i.e. containing silicon and magnesium in approximately equal proportions",
      "count": 2295,
      "sourceFile": "ipc_C22F.txt",
      "kind": "ipc"
    },
    "C22F1/053": {
      ...
      "level": 2,
      "parent": "C22F1/04",
      "ja": "次に多い成分として亜鉛を含む合金［４］",
      "en": "of alloys with zinc as the next major constituent",
      "count": 3118,
      "sourceFile": "ipc_C22F.txt",
      "kind": "ipc"
    },
    "C22F1/057": {
      ...
      "level": 2,
      "parent": "C22F1/04",
      "ja": "次に多い成分として銅を含む合金［４］",
      "en": "of alloys with copper as the next major constituent",
      "count": 2663,
      "sourceFile": "ipc_C22F.txt",
      "kind": "ipc"
    },
    "C22F1/06": {
      ...
      "level": 1,
      "parent": "C22F1/00",
      "ja": "マグネシウムまたはマグネシウム基合金",
      "en": "of magnesium or alloys based thereon",
      "count": 4636,
      "sourceFile": "ipc_C22F.txt",
      "kind": "ipc"
    },
    "C22F1/08": {
      ...
      "parent": "C22F1/00",
      "ja": "銅または銅基合金",
      "en": "of copper or alloys based thereon",
      "count": 12053,
      "sourceFile": "ipc_C22F.txt",
      "kind": "ipc"
    },
    "C22F1/10": {
      ...
      "level": 1,
      "parent": "C22F1/00",
      "ja": "ニッケルまたはコバルトまたはそれらを基とする合金",
      "en": "of nickel or cobalt or alloys based thereon",
      "count": 8121,
      "sourceFile": "ipc_C22F.txt",
      "kind": "ipc"
    },
    "C22F1/11": {
      ...
      "parent": "C22F1/00",
      "ja": "クロムまたはクロムを基とする合金",
      "en": "of chromium or alloys based thereon",
      "count": 195,
      "sourceFile": "ipc_C22F.txt",
      "kind": "ipc"
    },
    "C22F1/12": {
      ...
      "parent": "C22F1/00",
      "ja": "鉛または鉛基合金",
      "en": "of lead or alloys based thereon",
      "count": 195,
      "sourceFile": "ipc_C22F.txt",
      "kind": "ipc"
    },
    "C22F1/14": {
      ...
      "parent": "C22F1/00",
      "ja": "貴金属または貴金属を基とする合金",
      "en": "of noble metals or alloys based thereon",
      "count": 1847,
      "sourceFile": "ipc_C22F.txt",
      "kind": "ipc"
    },
    "C22F1/16": {
      ...
      "level": 1,
      "parent": "C22F1/00",
      "ja": "上記以外の金属またはそれを基とする合金",
      "en": "of other metals or alloys based thereon",
      "count": 2492,
      "sourceFile": "ipc_C22F.txt",
      "kind": "ipc"
    },
    "C22F1/18": {
      ...
      "level": 2,
      "parent": "C22F1/16",
      "ja": "高融点金属，耐火金属またはそれらを基とする合金",
      "en": "High-melting or refractory metals or alloys based thereon",
      "count": 10627,
      "sourceFile": "ipc_C22F.txt",
      "kind": "ipc"
    },
    "C22F3/00": {
      ...
      "level": 0,
      "parent": "C22F",
      "ja": "特殊な物理的方法，例．中性子処理，による非鉄金属または合金の物理的構造の変化",
      "en": "Changing the physical structure of non-ferrous metals or alloys by special physical methods, e.g. treatment with neutrons",
      "count": 1897,
      "sourceFile": "ipc_C22F.txt",
      "kind": "ipc"
    },
    "C22F3/02": {
      ...
      "level": 1,
      "parent": "C22F3/00",
      "ja": "超音波，電界または磁界により制御された溶湯の凝固によるもの",
      "en": "by solidifying a melt controlled by supersonic waves or electric or magnetic fields",
      "count": 396,
      "sourceFile": "ipc_C22F.txt",
      "kind": "ipc"
    }

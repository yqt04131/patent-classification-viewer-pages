window.IPC_SHARD_C08H = {
  "generatedAt": "2026-03-20T02:17:46.447Z",
  "total": 11,
  "entries": {
    "C08H": {
      "code": "C08H",
      "level": 0,
      "parent": "C08",
      "ja": "天然高分子化合物の誘導体（多糖類Ｃ０８Ｂ；天然ゴムＣ０８Ｃ；天然樹脂またはその誘導体Ｃ０９Ｆ；ピッチ，アスファルト，ビチューメンの処理Ｃ１０Ｃ３／００）<br><br><b><ul>注</ul></b><br>化合物の治療活性は，サブクラスＡ６１Ｐにさらに分類する。［７］",
      "en": "DERIVATIVES OF NATURAL MACROMOLECULAR COMPOUNDS(polysaccharides <b>C08B</b>; natural rubber <b>C08C</b>; natural resins or their derivatives <b>C09F</b>; working up pitch, asphalt or bitumen <b>C10C3/00</b>);<br><br><b><u>Note(s)</u></b><br><br><ul><li>Therapeutic activity of compounds is further classified in subclass <b>A61P</b>.</li></ul>",
      "count": 231,
    ...
    "C08H1/00": {
      ...
      "en": "Macromolecular products derived from proteins(food proteins <b>A23</b>, e.g. <b>A23J</b>; preparation of glue or gelatine <b>C09H</b>)",
      "count": 2040,
      "sourceFile": "ipc_C08H.txt",
      "kind": "ipc"
    },
    "C08H1/02": {
      "code": "C08H1/02",
    ...
    "C08H7/00": {
      ...
      "en": "Lignin; Modified lignin; High-molecular-weight products derived therefrom(low-molecular-weight derivatives of lignin <b>C07G1/00</b>)",
      "count": 4242,
      "sourceFile": "ipc_C08H.txt",
      "kind": "ipc"
    },
    "C08H8/00": {
      ...
      "en": "Macromolecular compounds derived from lignocellulosic materials",
      "count": 2355,
      "sourceFile": "ipc_C08H.txt",
      "kind": "ipc"
    },

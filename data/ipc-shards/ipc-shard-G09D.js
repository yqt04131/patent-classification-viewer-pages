window.IPC_SHARD_G09D = {
  "generatedAt": "2026-03-20T02:17:47.116Z",
  "total": 11,
  "entries": {
    "G09D": {
      "code": "G09D",
      "level": 0,
      "parent": "G09",
      "ja": "鉄道またはこれに類するものの時刻表または料金表；万年カレンダー",
      "en": "RAILWAY OR LIKE TIME OR FARE TABLES; PERPETUAL CALENDARS",
      "count": 384,
    ...
    "G09D1/00": {
      ...
      "level": 0,
      "parent": "G09D",
      "ja": "鉄道またはこれに類するものの時刻表または料金表；その表示または読取りを助けるもの（地図あるいは道程表に組み込んだもの，例．鉄道路線図Ｇ０９Ｂ２９／００）",
      "en": "Railway or like time or fare tables; Indicating or reading aids therefor(incorporating maps or route diagrams, e.g. railway routing charts <b>G09B29/00</b>)",
      "count": 963,
      "sourceFile": "ipc_G09D.txt",
      "kind": "ipc"
    },
    "G09D3/00": {
      "code": "G09D3/00",
      "level": 0,
      "parent": "G09D",
      "ja": "万年カレンダー（印刷されたカレンダー帳Ｂ４２Ｄ５／０４：時計仕掛け万年カレンダーＧ０４Ｂ１９／２４）",
      "en": "Perpetual calendars(printed calendar blocks <b>B42D5/04</b>; clockwork-driven perpetual calendars <b>G04B19/24</b>)",
      "count": 1491,
      "sourceFile": "ipc_G09D.txt",
      "kind": "ipc"
    },
    "G09D3/02": {
      ...
      "level": 1,
      "parent": "G09D3/00",
      "ja": "表示部分を有した交換自在の部材をもつもの",
      "en": "with interchangeable members bearing the indicia",
      "count": 619,
      "sourceFile": "ipc_G09D.txt",
      "kind": "ipc"
    },
    "G09D3/04": {
      ...
      "level": 1,
      "parent": "G09D3/00",
      "ja": "表示部材がカレンダーに可動自在に組み込まれているもの",
      "en": "wherein members bearing the indicia are movably mounted in the calendar",
      "count": 690,
      "sourceFile": "ipc_G09D.txt",
      "kind": "ipc"
    },

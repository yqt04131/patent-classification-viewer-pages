window.IPC_SHARD_C09C = {
  "generatedAt": "2026-03-20T02:17:46.458Z",
  "total": 44,
  "entries": {
    "C09C": {
      "code": "C09C",
      "level": 0,
      "parent": "C09",
      "ja": "顔料または充てん剤の性質を改良するための，繊維性充てん剤以外の無機物質の処理（モルタル，コンクリート，人造石またはその類似物に対する物質の充てん性を向上させるのに特に適した処理，Ｃ０４Ｂ１４／００，Ｃ０４Ｂ１８／００，Ｃ０４Ｂ２０／００）；カーボンブラックの製造<br><br><b><ul>注</ul></b><br>このサブクラスにおいては，ラストプレイス優先ルールが適用される，すなわち各階層レベルにおいて相反する指示がない限り，化合物は最後の適切な箇所に分類される。",
      "en": "TREATMENT OF INORGANIC MATERIALS, OTHER THAN FIBROUS FILLERS, TO ENHANCE THEIR PIGMENTING OR FILLING PROPERTIES(treatment of materials specially adapted to enhance their filling properties in mortars, concrete or artificial stone <b>C04B14/00</b>, <b>C04B18/00</b>, <b>C04B20/00</b>);PREPARATION OF CARBON BLACK; <br><br><b><u>Note(s)</u></b><br><br><ul><li>In this subclass, the last place priority rule is applied, i.e. at each hierarchical level, in the absence of an indication to the contrary, a compound is classified in the last appropriate place.</li></ul>",
      "count": 516,
    ...
    "C09C1/00": {
      ...
      "level": 0,
      "parent": "C09C",
      "ja": "繊維性充てん剤以外の特定の無機物質の処理（テネブレッセンス物質Ｃ０９Ｋ９／００；発光性物質Ｃ０９Ｋ１１／００）；カーボンブラックの製造［２００６．０１］",
      "en": "Treatment of specific inorganic materials other than fibrous fillers (tenebrescent materials <b>C09K9/00</b>; luminescent materials <b>C09K11/00</b>);Preparation of carbon black",
      "count": 8371,
      "sourceFile": "ipc_C09C.txt",
      "kind": "ipc"
    },
    "C09C1/02": {
      "code": "C09C1/02",
      "level": 1,
      "parent": "C09C1/00",
      "ja": "アルカリ土類金属またはマグネシウム化合物",
      "en": "Compounds of alkaline earth metals or magnesium",
      "count": 4069,
      "sourceFile": "ipc_C09C.txt",
      "kind": "ipc"
    },
    ...
    "C09C1/54": {
      ...
      "level": 3,
      "parent": "C09C1/48",
      "ja": "アセチレンブラック，サーマルブラック",
      "en": "Acetylene black; thermal black",
      "count": 559,
      "sourceFile": "ipc_C09C.txt",
      "kind": "ipc"
    },
    ...
    "C09C1/62": {
      ...
      "level": 1,
      "parent": "C09C1/00",
      "ja": "金属顔料または充てん剤［２００６．０１］",
      "en": "Metallic pigments or fillers",
      "count": 2001,
      "sourceFile": "ipc_C09C.txt",
      "kind": "ipc"
    },
    ...
    "C09C3/00": {
      ...
      "level": 0,
      "parent": "C09C",
      "ja": "顔料性または充てん剤の性質を改良するための，繊維性充てん剤以外の無機物質の一般的処理［２００６．０１］",
    ...
    "C09C3/04": {
      ...
      "level": 1,
      "parent": "C09C3/00",
      "ja": "物理的処理，例．粉砕，超音波振動による処理［２００６．０１］",
      "en": "Physical treatment, e.g. grinding or treatment with ultrasonic vibrations",
      "count": 4009,
      "sourceFile": "ipc_C09C.txt",
      "kind": "ipc"
    },
    ...
    "C09C3/08": {
      ...
      "parent": "C09C3/00",
      "ja": "低分子有機化合物による処理［２］",
      "en": "Treatment with low-molecular-weight organic compounds",
      "count": 7747,
      "sourceFile": "ipc_C09C.txt",
      "kind": "ipc"
    },
    "C09C3/10": {
      ...
      "parent": "C09C3/00",
      "ja": "高分子有機化合物による処理［２］",
      "en": "Treatment with macromolecular organic compounds",
      "count": 7129,
      "sourceFile": "ipc_C09C.txt",
      "kind": "ipc"
    },
    "C09C3/12": {
      ...
      "parent": "C09C3/00",
      "ja": "有機けい素化合物による処理［２］",
      "en": "Treatment with organosilicon compounds",
      "count": 5226,
      "sourceFile": "ipc_C09C.txt",
      "kind": "ipc"
    }

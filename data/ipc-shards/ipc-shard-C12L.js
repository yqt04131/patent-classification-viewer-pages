window.IPC_SHARD_C12L = {
  "generatedAt": "2026-03-20T02:17:46.502Z",
  "total": 6,
  "entries": {
    "C12L": {
      "code": "C12L",
      "level": 0,
      "parent": "C12",
      "ja": "ピッチ塗りまたはピッチ除去装置；貯蔵室の道具類<br><br><b><ul>注</ul></b><br>このサブクラスにおいては，サブクラスＣ１２Ｒのインデキシングコードを付与することが望ましい。［６］",
      "en": "PITCHING OR DEPITCHING MACHINES; CELLAR TOOLS; <br><br><b><u>Note(s)</u></b><br><br><ul><li>In this subclass, it is desirable to add the indexing codes of subclass <b>C12R</b>. </li></ul>",
      "count": 55,
    ...
    "C12L3/00": {
      ...
      "parent": "C12L",
      "ja": "ピッチ塗りまたはピッチ除去装置",
      "en": "Pitching or depitching machines",
      "count": 12,
      "sourceFile": "ipc_C12L.txt",
      "kind": "ipc"
    },
    "C12L9/00": {
      "code": "C12L9/00",
      "level": 0,
      "parent": "C12L",
      "ja": "たる，胴太だるまたはその類似物の空気抜き穴開口装置",
      "en": "Venting devices for casks, barrels, or the like",
      "count": 327,
      "sourceFile": "ipc_C12L.txt",
      "kind": "ipc"
    },

window.IPC_SHARD_C13K = {
  "generatedAt": "2026-03-20T02:17:46.512Z",
  "total": 14,
  "entries": {
    "C13K": {
      "code": "C13K",
      "level": 0,
      "parent": "C13",
      "ja": "天然素材から得られるまたは天然素材である二糖類，オリゴ糖類，または多糖類の加水分解によって得られる糖類（蔗糖の製造Ｃ１３Ｂ；化学的合成された糖または糖誘導体Ｃ０７Ｈ；多糖類，例．でん粉，その誘導体Ｃ０８Ｂ；麦芽Ｃ１２Ｃ；糖類基を有する化合物の製造のために発酵または酵素を使用する方法Ｃ１２Ｐ１９／００）",
      "en": "SACCHARIDES OBTAINED FROM NATURAL SOURCES OR BY HYDROLYSIS OF NATURALLY OCCURRING DISACCHARIDES, OLIGOSACCHARIDES OR POLYSACCHARIDES(production of sucrose <b>C13B</b>; chemically synthesised sugars or sugar derivatives <b>C07H</b>; polysaccharides, e.g. starch, derivatives thereof <b>C08B</b>; malt <b>C12C</b>; fermentation or enzyme-using processes for preparing compounds containing saccharide radicals <b>C12P19/00</b>)",
      "count": 166,
    ...
    "C13": {
      ...
      "level": 0,
      "parent": "C",
      "ja": "糖工業［４］<br><br><b><ul>注</ul></b><br>（１）このクラスＣ１３においては，下記の用語または表現は以下に示す意味で用いる。<br>―“糖（ｓｕｇａｒｓ）”とは，特徴的な甘味を持ち，食用であり，水溶性結晶炭水化物の集合であって，単糖類，二糖類およびオリゴ糖類，例．蔗糖，乳糖および果糖，を含む。“糖（ｓｕｇａｒｓ）”のより明確な意味は，サブクラスＣ１３Ｂの注で定義される。［２０１１．０１］",
      "en": "SUGAR INDUSTRY; <br><br><b><u>Note(s)</u></b><br><br><ul><li>In class <b>C13</b>, the following terms or expressions are used with the meanings indicated: <ul><li>\"sugars\" are a class of edible, water-soluble crystalline carbohydrates, having a characteristic sweet taste, including mono-, di- and oligosaccharides, e.g. sucrose, lactose and fructose. A more specific meaning of the term \"sugar\" is defined in the note of subclass <b>C13B</b>.  </li></ul></li></ul>",
      "count": 0,
      "sourceFile": "ipc_C.txt",
      "kind": "ipc"
    },
    ...
    "C13K1/00": {
      ...
      "en": "Glucose(separation from invert sugar <b>C13K3/00</b>);Glucose-containing syrups",
      "count": 748,
      "sourceFile": "ipc_C13K.txt",
      "kind": "ipc"
    },
    "C13K1/02": {
      "code": "C13K1/02",
      ...
      "en": "obtained by saccharification of cellulosic materials(manufacture of fodder <b>A23K10/32</b>)",
      "count": 2377,
      "sourceFile": "ipc_C13K.txt",
      "kind": "ipc"
    },
    ...
    "C13K11/00": {
      ...
      "en": "Fructose(separation from invert sugar <b>C13K3/00</b>)",
      "count": 1005,
      "sourceFile": "ipc_C13K.txt",
      "kind": "ipc"
    },

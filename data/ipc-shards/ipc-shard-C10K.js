window.IPC_SHARD_C10K = {
  "generatedAt": "2026-03-20T02:17:46.482Z",
  "total": 25,
  "entries": {
    "C10K": {
      "code": "C10K",
      "level": 0,
      "parent": "C10",
      "ja": "一酸化炭素含有可燃性ガスの精製または化学組成の精製または変性",
      "en": "PURIFYING OR MODIFYING THE CHEMICAL COMPOSITION OF COMBUSTIBLE GASES CONTAINING CARBON MONOXIDE",
      "count": 184,
    ...
    "C10K1/00": {
      ...
      "level": 0,
      "parent": "C10K",
      "ja": "一酸化炭素含有可燃性ガスの精製（水素および一酸化炭素を含有する混合物からの水素の遊離化Ｃ０１Ｂ３／５０）",
      "en": "Purifying combustible gases containing carbon monoxide(isolation of hydrogen from mixtures containing hydrogen and carbon monoxide <b>C01B3/50</b>)",
      "count": 5349,
      "sourceFile": "ipc_C10K.txt",
      "kind": "ipc"
    },
    "C10K1/02": {
      "code": "C10K1/02",
    ...
    "C10K1/04": {
      ...
      "level": 1,
      "parent": "C10K1/00",
      "ja": "非ガス状物質を冷却して凝縮するもの",
      "en": "by cooling to condense non-gaseous materials",
      "count": 2913,
      "sourceFile": "ipc_C10K.txt",
      "kind": "ipc"
    },
    "C10K1/06": {
      ...
      "parent": "C10K1/04",
      "ja": "ウオータスプレーと結合されたもの",
      "en": "combined with spraying with water",
      "count": 584,
      "sourceFile": "ipc_C10K.txt",
      "kind": "ipc"
    },
    "C10K1/08": {
      ...
      "level": 1,
      "parent": "C10K1/00",
      "ja": "液体による洗浄によるもの；使用済み洗浄液の再生",
      "en": "by washing with liquids; Reviving the used wash liquors",
      "count": 1915,
      "sourceFile": "ipc_C10K.txt",
      "kind": "ipc"
    },
    ...
    "C10K1/20": {
      ...
      "level": 1,
      "parent": "C10K1/00",
      "ja": "固体による処理によるもの；消費済み精製用塊の再生",
      "en": "by treating with solids; Regenerating spent purifying masses",
      "count": 1075,
      "sourceFile": "ipc_C10K.txt",
      "kind": "ipc"
    },
    "C10K1/22": {
      ...
      "parent": "C10K1/20",
      "ja": "装置，例．乾式箱型精製器",
      "en": "Apparatus, e.g. dry box purifiers",
      "count": 542,
      "sourceFile": "ipc_C10K.txt",
      "kind": "ipc"
    },
    "C10K1/24": {
      ...
      "parent": "C10K1/22",
      "ja": "精製用物質の支持手段",
      "en": "Supporting means for the purifying material",
      "count": 71,
      "sourceFile": "ipc_C10K.txt",
      "kind": "ipc"
    },
    "C10K1/26": {
      ...
      "parent": "C10K1/20",
      "ja": "精製用物質の再生",
      "en": "Regeneration of the purifying material",
      "count": 350,
      "sourceFile": "ipc_C10K.txt",
      "kind": "ipc"
    },
    "C10K1/28": {
      ...
      "parent": "C10K1/20",
      "ja": "精製器を通して流れるガスの調節",
      "en": "Controlling the gas flow through the purifiers",
      "count": 95,
      "sourceFile": "ipc_C10K.txt",
      "kind": "ipc"
    },
    "C10K1/30": {
      ...
      "parent": "C10K1/20",
      "ja": "移動する精製用塊をもつもの",
      "en": "with moving purifying masses",
      "count": 175,
      "sourceFile": "ipc_C10K.txt",
      "kind": "ipc"
    },
    "C10K1/32": {
      ...
      "level": 1,
      "parent": "C10K1/00",
      "ja": "選択的吸着性固体をもつもの，例．活性炭",
      "en": "with selectively absorptive solids, e.g. active carbon",
      "count": 1932,
      "sourceFile": "ipc_C10K.txt",
      "kind": "ipc"
    },
    "C10K1/34": {
      ...
      "level": 1,
      "parent": "C10K1/00",
      "ja": "不純物の接触転化により，より除去し易い物質とするもの",
      "en": "by catalytic conversion of impurities to more readily removable materials",
      "count": 1567,
      "sourceFile": "ipc_C10K.txt",
      "kind": "ipc"
    },
    "C10K3/00": {
      ...
      "level": 0,
      "parent": "C10K",
      "ja": "一酸化炭素含有可燃性ガスの化学組成を変性して改良された燃料を製造するもの，例．一酸化炭素を含まず発熱量の異なったガス",
      "en": "Modifying the chemical composition of combustible gases containing carbon monoxide to produce an improved fuel, e.g. one of different calorific value, which may be free from carbon monoxide",
      "count": 1183,
      "sourceFile": "ipc_C10K.txt",
      "kind": "ipc"
    },
    ...
    "C10K3/04": {
      ...
      "parent": "C10K3/02",
      "ja": "一酸化炭素含有量の減少",
      "en": "reducing the carbon monoxide content",
      "count": 1541,
      "sourceFile": "ipc_C10K.txt",
      "kind": "ipc"
    },

window.IPC_SHARD_G09C = {
  "generatedAt": "2026-03-20T02:17:47.114Z",
  "total": 18,
  "entries": {
    "G09C": {
      "code": "G09C",
      "level": 0,
      "parent": "G09",
      "ja": "秘密の必要性を含む暗号または他の目的のための暗号化または暗号解読装置",
      "en": "CIPHERING OR DECIPHERING APPARATUS FOR CRYPTOGRAPHIC OR OTHER PURPOSES INVOLVING THE NEED FOR SECRECY",
      "count": 128,
    ...
    "G09C1/00": {
      ...
      "en": "Apparatus or methods whereby a given sequence of signs, e.g. an intelligible text, is transformed into an unintelligible sequence of signs by transposing the signs or groups of signs or by replacing them by others according to a predetermined system(cryptographic typewriters <b>G09C3/00</b>)",
      "count": 17583,
      "sourceFile": "ipc_G09C.txt",
      "kind": "ipc"
    },
    "G09C1/02": {
      "code": "G09C1/02",

window.IPC_SHARD_C12H = {
  "generatedAt": "2026-03-20T02:17:46.496Z",
  "total": 29,
  "entries": {
    "C12H": {
      "code": "C12H",
      "level": 0,
      "parent": "C12",
      "ja": "アルコール飲料の，低温殺菌，殺菌，保存，精製，清澄または熟成；発酵液またはアルコール飲料のアルコール含量を変える方法（ぶどう酒の脱酸Ｃ１２Ｇ１／１０；粗酒石の沈殿防止Ｃ１２Ｇ１／１２；香気添加による模造熟成Ｃ１２Ｇ３／０６）［６］<br><br><b><ul>注</ul></b><br>（１）このグループに分類するとき，クロマトグラフィーに関する一般分野の主題事項が関係している限り，グループＢ０１Ｄ１５／０８にも分類する。［８］<br>（２）このサブクラスにおいて，サブクラスＣ１２Ｒのインデキシングコードを付与することが望ましい。［６］",
      "en": "PASTEURISATION, STERILISATION, PRESERVATION, PURIFICATION, CLARIFICATION OR AGEING OF ALCOHOLIC BEVERAGES; METHODS FOR ALTERING THE ALCOHOL CONTENT OF FERMENTED SOLUTIONS OR ALCOHOLIC BEVERAGES (deacidification of wine <b>C12G1/10</b>; preventing winestone precipitation <b>C12G1/12</b>; simulation ageing by flavouring <b>C12G3/06</b>);<br><br><b><u>Note(s)</u></b><br><br><ul><li>When classifying in this subclass, classification is also made in group <b>B01D15/08</b> insofar as subject matter of general interest relating to chromatography is concerned.   </li><li>In this subclass, it is desirable to add the indexing codes of subclass <b>C12R</b>.    </li></ul>",
      "count": 139,
    ...
    "C12H1/00": {
      ...
      "level": 0,
      "parent": "C12H",
      "ja": "アルコール飲料の低温殺菌，殺菌，保存，精製，清澄または熟成",
      "en": "Pasteurisation, sterilisation, preservation, purification, clarification, or ageing of alcoholic beverages",
      "count": 1678,
      "sourceFile": "ipc_C12H.txt",
      "kind": "ipc"
    },
    "C12H1/02": {
      "code": "C12H1/02",
      "level": 1,
      "parent": "C12H1/00",
      "ja": "沈でん物または添加物質，例．吸着剤，の除去との組み合せ",
      "en": "combined with removal of precipitate or added materials, e.g. adsorption material",
      "count": 660,
      "sourceFile": "ipc_C12H.txt",
      "kind": "ipc"
    },
    "C12H1/04": {
      ...
      "level": 2,
      "parent": "C12H1/02",
      "ja": "イオン交換樹脂または不活性清澄化剤，例．吸着剤，の補助手段をもつもの",
      "en": "with the aid of ion-exchange material or inert clarification material, e.g. adsorption material",
      "count": 632,
      "sourceFile": "ipc_C12H.txt",
      "kind": "ipc"
    },
    "C12H1/044": {
      ...
      "parent": "C12H1/04",
      "ja": "無機物質の補助手段をもつもの［６］",
      "en": "with the aid of inorganic material",
      "count": 739,
      "sourceFile": "ipc_C12H.txt",
      "kind": "ipc"
    },
    "C12H1/048": {
      ...
      "parent": "C12H1/044",
      "ja": "シリコン含有物質をもつもの［６］",
      "en": "with silicon containing material",
      "count": 538,
      "sourceFile": "ipc_C12H.txt",
      "kind": "ipc"
    },
    "C12H1/052": {
      ...
      "parent": "C12H1/04",
      "ja": "有機物質の補助手段をもつもの［６］",
      "en": "with the aid of organic material",
      "count": 436,
      "sourceFile": "ipc_C12H.txt",
      "kind": "ipc"
    },
    ...
    "C12H1/06": {
      ...
      "level": 2,
      "parent": "C12H1/02",
      "ja": "物理的手段，例．照射，振動，による沈でん",
      "en": "Precipitation by physical means, e.g. by irradiation, vibrations",
      "count": 685,
      "sourceFile": "ipc_C12H.txt",
      "kind": "ipc"
    },
    "C12H1/065": {
      ...
      "parent": "C12H1/06",
      "ja": "遠心分離［６］",
      "en": "Separation by centrifugation",
      "count": 161,
      "sourceFile": "ipc_C12H.txt",
      "kind": "ipc"
    },
    ...
    "C12H1/10": {
      ...
      "parent": "C12H1/02",
      "ja": "化学的手段による沈でん",
      "en": "Precipitation by chemical means",
      "count": 170,
      "sourceFile": "ipc_C12H.txt",
      "kind": "ipc"
    },
    ...
    "C12H1/14": {
      ...
      "level": 2,
      "parent": "C12H1/12",
      "ja": "非沈でん性物質によるもの，例．亜硫酸化；金属封鎖作用，例．キレート生成物質添加によるもの",
      "en": "with non-precipitating compounds, e.g. sulfiting; Sequestration, e.g. with chelate-producing compounds",
      "count": 1024,
      "sourceFile": "ipc_C12H.txt",
      "kind": "ipc"
    },
    ...
    "C12H1/16": {
      ...
      "parent": "C12H1/12",
      "ja": "物理的手段，例．照射，によるもの",
      "en": "by physical means, e.g. irradiation",
      "count": 2210,
      "sourceFile": "ipc_C12H.txt",
      "kind": "ipc"
    },
    ...
    "C12H1/20": {
      ...
      "level": 4,
      "parent": "C12H1/18",
      "ja": "内容物の膨張する余地のある容器中におけるもの",
      "en": "in containers allowing for expansion of the contents",
      "count": 67,
      "sourceFile": "ipc_C12H.txt",
      "kind": "ipc"
    },
    "C12H1/22": {
      ...
      "level": 1,
      "parent": "C12H1/00",
      "ja": "貯蔵による熟成，例．ビールのラガーリング",
      "en": "Ageing or ripening by storing, e.g. lagering of beer",
      "count": 2497,
      "sourceFile": "ipc_C12H.txt",
      "kind": "ipc"
    },
    "C12H3/00": {
      ...
      "level": 0,
      "parent": "C12H",
      "ja": "低アルコール飲料または非アルコール飲料を得るための発酵液またはアルコール飲料のアルコール含量を減少させる方法［２０１９．０１］",
      "en": "Methods for reducing the alcohol content of fermented solutions or alcoholic beverages to obtain low-alcohol or non-alcoholic beverages",
      "count": 276,
      "sourceFile": "ipc_C12H.txt",
      "kind": "ipc"
    },
    ...
    "C12H3/04": {
      ...
      "level": 1,
      "parent": "C12H3/00",
      "ja": "半透過膜を用いるもの［２０１９．０１］",
      "en": "using semi-permeable membranes",
      "count": 134,
      "sourceFile": "ipc_C12H.txt",
      "kind": "ipc"
    },
    "C12H6/00": {
      ...
      "level": 0,
      "parent": "C12H",
      "ja": "発酵液またはアルコール飲料のアルコール含量を増加させる方法［２０１９．０１］",
      "en": "Methods for increasing the alcohol content of fermented solutions or alcoholic beverages",
      "count": 206,
      "sourceFile": "ipc_C12H.txt",
      "kind": "ipc"
    },

window.IPC_SHARD_G06J = {
  "generatedAt": "2026-03-20T02:17:47.089Z",
  "total": 6,
  "entries": {
    "G06J": {
      "code": "G06J",
      "level": 0,
      "parent": "G06",
      "ja": "ハイブリッド計算装置（光学的ハイブリッド計算装置Ｇ０６Ｅ３／００）<br><br><b><ul>注</ul></b><br>注<br>このサブクラスにおいては，下記の表現は以下に示す意味で用いる；<br>・“ハイブリッド計算装置”とは計算のある一部がデジタル的で，他の一部がアナログ的なものである。",
      "en": "HYBRID COMPUTING ARRANGEMENTS(optical hybrid computing devices <b>G06E3/00</b>);<br><br><b><u>Note(s)</u></b><br><br><ul><li>In this subclass, the following expression is used with the meaning indicated:<ul><li>\"hybrid computing arrangement\" is an arrangement in which part of the computation is digital and part is analogue.</li></ul></li></ul>",
      "count": 25,

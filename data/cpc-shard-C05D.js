window.CPC_SHARD_C05D = {
  "generatedAt": "2026-03-20T02:17:57.234Z",
  "total": 14,
  "entries": {
    "C05D": {
      "code": "C05D",
      "level": 5,
      "parent": "C05",
      "ja": "　サブクラスＣ０５Ｂ，Ｃ０５Ｃに包含されない無機質肥料；二酸化炭素を生成する肥料｛特記．　ＩＰＣグループＣ０５Ｄ１１／００(ＥＣＬＡ)は，内部ＥＣＬＡ分類表には使用されない。このグループに包含される主題事項は，ＥＣＬＡグループＣ０５Ｄ１／００からＣ０５Ｄ９／００のひとつに分類される。（クラスＣ０５のタイトルの後の内部注．を参照）｝",
      "en": "INORGANIC FERTILISERS NOT COVERED BY SUBCLASSES C05B, C05C; FERTILISERS PRODUCING CARBON DIOXIDE<br><br><u>WARNING</u><br>The following IPC groups are not in the CPC scheme. The subject matter for these IPC groups is classified in the following CPC groups: C05D11/00covered byC05D1/00 - C05D9/00 (see internal note after the title of class C05)",
      "count": 0,
      "ipcCode": "",
      "coreCode": "",
      "note": "",
    ...
    "C05D1/00": {
      ...
      "en": "Fertilisers containing potassium (C05D7/00 takes precedence)",
      "count": 11945,
      "ipcCode": "C05D1/00",
      "coreCode": "C05D1/00",
      "note": "",
      "sourceFile": "cpc_C05D.txt",
      "kind": "cpc"
    },
    "C05D1/005": {
      "code": "C05D1/005",
    ...
    "C05D3/00": {
      ...
      "en": "Calcareous fertilisers (C05D7/00 takes precedence)",
      "count": 7825,
      "ipcCode": "C05D3/00",
      "coreCode": "C05D3/00",
      "note": "",
    ...
    "C05D3/02": {
      ...
      "en": "from limestone, calcium carbonate, calcium hydrate, slaked lime, calcium oxide, waste calcium products",
      "count": 8088,
      "ipcCode": "C05D3/02",
      "coreCode": "C05D3/02",
      "note": "",
    ...
    "C05D5/00": {
      ...
      "en": "Fertilisers containing magnesium (C05D7/00 takes precedence)",
      "count": 11364,
      "ipcCode": "C05D5/00",
      "coreCode": "C05D5/00",
      "note": "",

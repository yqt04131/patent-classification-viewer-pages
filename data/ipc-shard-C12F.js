window.IPC_SHARD_C12F = {
  "generatedAt": "2026-03-20T02:17:46.494Z",
  "total": 10,
  "entries": {
    "C12F": {
      "code": "C12F",
      "level": 0,
      "parent": "C12",
      "ja": "発酵液の副産物の採取（ぶどう酒または発泡性ぶどう酒からの酵母の除去Ｃ１２Ｇ１／０８）；変性アルコール；その調製［６］<br><br><b><ul>注</ul></b><br>このサブクラスにおいては，サブクラスＣ１２Ｒのインデキシングコードを付与することが望ましい。［６］",
      "en": "RECOVERY OF BY-PRODUCTS OF FERMENTED SOLUTIONS(removal of yeast from wine or sparkling wine <b>C12G1/08</b>);DENATURED ALCOHOL; PREPARATION THEREOF; <br><br><b><u>Note(s)</u></b><br><br><ul><li>In this subclass, it is desirable to add the indexing codes of subclass <b>C12R</b>.  </li></ul>",
      "count": 79,
    ...
    "C12F3/06": {
      ...
      "en": "from beer or wine(<b>C12F3/02</b> takes precedence; removal of yeast of wine <b>C12G1/08</b>)",
      "count": 414,
      "sourceFile": "ipc_C12F.txt",
      "kind": "ipc"
    },
    "C12F3/08": {
      ...
      "en": "Recovery of alcohol from press residues or other waste material(from carbon dioxide <b>C12F3/04</b>)",
      "count": 157,
      "sourceFile": "ipc_C12F.txt",
      "kind": "ipc"
    },

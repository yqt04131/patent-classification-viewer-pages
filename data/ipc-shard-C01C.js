window.IPC_SHARD_C01C = {
  "generatedAt": "2026-03-20T02:17:46.376Z",
  "total": 36,
  "entries": {
    "C01C": {
      "code": "C01C",
      "level": 0,
      "parent": "C01",
      "ja": "アンモニア；シアン；それらの化合物（ハロゲンのオキシ酸塩Ｃ０１Ｂ１１／００；過酸化物，ペルオキシ酸塩Ｃ０１Ｂ１５／００；チオ硫酸塩，亜ニチオン酸塩，多チオン酸塩Ｃ０１Ｂ１７／６４；セレンまたはテルルを含む化合物Ｃ０１Ｂ１９／００；アジドＣ０１Ｂ２１／０８；金属アミドＣ０１Ｂ２１／０９２；亜硝酸塩Ｃ０１Ｂ２１／５０；りん化物Ｃ０１Ｂ２５／０８；りんのオキシ酸塩Ｃ０１Ｂ２５／１６；けい素を含む化合物Ｃ０１Ｂ３３／００；ほう素を含む化合物Ｃ０１Ｂ３５／００；発酵によるかまたは酵素を使用した元素または二酸化炭素以外の無機化合物の製造Ｃ１２Ｐ３／００；電気分解または電気泳動による非金属元素または無機化合物の製造Ｃ２５Ｂ）<br><br><b><ul>注</ul></b><br>（１）サブクラスＣ０１ＢからＣ０１Ｇに適用するラストプレイス優先ルールを規定するクラスＣ０１に続くクラス注（１）に注意すること［８］<br>（２）化合物の治療活性は，サブクラスＡ６１Ｐにさらに分類する［７］",
      "en": "AMMONIA; CYANOGEN; COMPOUNDS THEREOF(salts of oxyacids of halogens <b>C01B11/00</b>; peroxides, salts of peroxyacids <b>C01B15/00</b>; thiosulfates, dithionites, polythionates <b>C01B17/64</b>; compounds containing selenium or tellurium <b>C01B19/00</b>; azides <b>C01B21/08</b>; metal amides <b>C01B21/092</b>; nitrites <b>C01B21/50</b>; phosphides <b>C01B25/08</b>; salts of oxyacids of phosphorus <b>C01B25/16</b>; compounds containing silicon <b>C01B33/00</b>; compounds containing boron <b>C01B35/00</b>; fermentation or enzyme-using processes for the preparation of elements or inorganic compounds except carbon dioxide <b>C12P3/00</b>; production of non-metallic elements or inorganic compounds by electrolysis or electrophoresis <b>C25B</b>);<br><br><b><u>Note(s)</u></b><br><br><ul><li>Attention is drawn to Note (1) after class <b>C01</b>, which defines the last place priority rule applied in this class, i.e. in the range of subclasses <b>C01B to C01G</b>  and within these subclasses.</li><li>Therapeutic activity of compounds is further classified in subclass <b>A61P</b>.</li></ul>",
      "count": 297,
    ...
    "C01C1/02": {
      ...
      "parent": "C01C1/00",
      "ja": "アンモニアの製造または分離",
      "en": "Preparation or separation of ammonia",
      "count": 3501,
      "sourceFile": "ipc_C01C.txt",
      "kind": "ipc"
    },
    "C01C1/04": {
      ...
      "level": 2,
      "parent": "C01C1/02",
      "ja": "合成によるアンモニアの製造（アンモニア合成用の混合ガスの製造または精製Ｃ０１Ｂ３／０２）",
      "en": "Preparation of ammonia by synthesis (preparation or purification of gas mixtures for ammonia synthesis <b>C01B3/025</b>)",
      "count": 5087,
      "sourceFile": "ipc_C01C.txt",
      "kind": "ipc"
    },
    ...
    "C01C1/10": {
      ...
      "level": 2,
      "parent": "C01C1/02",
      "ja": "アンモニア液，例．ガス液，からアンモニアの分離",
      "en": "Separation of ammonia from ammonia liquors, e.g. gas liquors",
      "count": 1253,
      "sourceFile": "ipc_C01C.txt",
      "kind": "ipc"
    },
    "C01C1/12": {
      ...
      "level": 2,
      "parent": "C01C1/02",
      "ja": "ガスおよび気体からアンモニアの分離",
      "en": "Separation of ammonia from gases and vapours",
      "count": 1360,
      "sourceFile": "ipc_C01C.txt",
      "kind": "ipc"
    },
    ...
    "C01C1/24": {
      ...
      "level": 1,
      "parent": "C01C1/00",
      "ja": "アンモニウムの硫酸塩（Ｃ０１Ｃ１／１４が優先）",
      "en": "Sulfates of ammonium(<b>C01C1/14</b> takes precedence)",
      "count": 2524,
      "sourceFile": "ipc_C01C.txt",
      "kind": "ipc"
    },
    ...
    "C01C1/248": {
      ...
      "level": 2,
      "parent": "C01C1/24",
      "ja": "結晶の固結防止または結晶の形または大きさの制御［２］",
      "en": "Preventing coalescing or controlling form or size of crystals",
      "count": 225,
      "sourceFile": "ipc_C01C.txt",
      "kind": "ipc"
    },
    ...
    "C01C1/28": {
      ...
      "level": 1,
      "parent": "C01C1/00",
      "ja": "アンモニウム塩の一般的製造方法<br><br><b><ul>注</ul></b><br>（１）このグループは，陰イオン中に金属を含有するアンモニウム錯塩（錯シアン化物以外）を包含しない。これは，金属にしたがってサブクラスＣ０１ＤからＣ０１Ｇの適切なグループに包含される。<br>（２）陽イオンとしてアンモニウムおよび金属が存在する多塩基酸の塩はアンモニウムがあたかも水素のように分類される。<br>（３）アンモニウム錯塩は金属にしたがってサブクラスＣ０１ＤからＣ０１Ｇの適切なグループに分類される。",
      "en": "Methods of preparing ammonium salts in general; <br><br><b><u>Note(s)</u></b><br><br><ul><li>This group <u>does not cover</u> ammonium salts of complex acids (other than complex cyanides) containing a metal in the anion, which are covered by the relevant groups of subclasses <b>C01D to C01G</b> , according to the metal.</li><li>Salts of polybasic acids with ammonium and a metal as cations are classified as though the ammonium were hydrogen.</li><li>Complex ammine salts are classified in the relevant groups of subclasses <b>C01D to C01G</b> , according to the metal.</li></ul>",
      "count": 220,
      "sourceFile": "ipc_C01C.txt",
      "kind": "ipc"
    },
    ...
    "C01C3/02": {
      ...
      "parent": "C01C3/00",
      "ja": "シアン化水素の製造",
      "en": "Preparation of hydrogen cyanide",
      "count": 1223,
      "sourceFile": "ipc_C01C.txt",
      "kind": "ipc"
    },
    ...
    "C01C3/08": {
      ...
      "level": 1,
      "parent": "C01C3/00",
      "ja": "金属のシアン化物または錯シアン化物",
      "en": "Simple or complex cyanides of metals",
      "count": 363,
      "sourceFile": "ipc_C01C.txt",
      "kind": "ipc"
    },
    ...
    "C01C3/20": {
      ...
      "parent": "C01C3/00",
      "ja": "チオシアン酸；その塩",
      "en": "Thiocyanic acid; Salts thereof",
      "count": 707,
      "sourceFile": "ipc_C01C.txt",
      "kind": "ipc"
    }

window.CPC_SHARD_G10G = {
  "generatedAt": "2026-03-20T02:17:58.994Z",
  "total": 14,
  "entries": {
    "G10G": {
      "code": "G10G",
      "level": 5,
      "parent": "G10",
      "ja": "音楽補助具（音楽教習Ｇ０９Ｂ１５／００）",
      "en": "REPRESENTATION OF MUSIC; RECORDING MUSIC IN NOTATION FORM; ACCESSORIES FOR MUSIC OR MUSICAL INSTRUMENTS NOT OTHERWISE PROVIDED FOR, e.g. SUPPORTS (music stands A47B; non-musical aspects of musical toy instruments A63H5/00; metronomes G04F5/02; teaching music G09B15/00)<br><br><u>WARNING</u><br><br>In this subclass non-limiting references (in the sense of paragraph 39 of the Guide to the IPC) may still be displayed in the scheme.",
      "count": 0,
      "ipcCode": "",
      "coreCode": "",
      "note": "",
    ...
    "G10G1/02": {
      ...
      "level": 8,
      "parent": "G10G1/00",
      "ja": "鍵盤又は指板のためのコード又は音高の指示器",
      "en": "Chord or note indicators, fixed or adjustable, for keyboard of fingerboards",
      "count": 742,
      "ipcCode": "G10G1/02",
      "coreCode": "G10G1/02",
      "note": "",
    ...
    "G10G3/00": {
      ...
      "level": 7,
      "parent": null,
      "ja": "記譜法形式に音楽を記録するもの，例．楽器の機械的操作を記録するもの",
    ...
    "G10G5/00": {
      ...
      "level": 7,
      "parent": null,
      "ja": "楽器のための支持具（エンドピン又はその部品Ｇ１０Ｄ３／００３）",
      "en": "Supports for musical instruments {(cellopins or components therefor G10D3/01)}",
      "count": 1533,
      "ipcCode": "G10G5/00",
      "coreCode": "G10G5/00",
      "note": "",
    ...
    "G10G5/005": {
      ...
      "level": 8,
      "parent": "G10G5/00",
      "ja": "｛演奏中に使用するもの〔例．コード，ストラップ又はハーネス〕（楽器の一部としての台又は保護具は個別の楽器を参照〔例．Ｇ１０Ｄ３／１８〕）｝",
      "en": "{while playing, e.g. cord, strap or harness (rests or guards as part of the instruments, see the particular instruments, e.g. G10D3/18)}",
      "count": 957,
      "ipcCode": "G10G5/00",
      "coreCode": "G10G5/00",
      "note": "",
    ...
    "G10G7/00": {
      ...
      "level": 7,
      "parent": null,
      "ja": "他の補助装置又は付属品〔例．指揮棒，別体になったやに入れ又は別体になった弦入れ〕",
    ...
    "G10G7/005": {
      ...
      "en": "{Carrying cases for musical instruments (interior fittings for luggage A45C13/02)}",
      "count": 571,
      "ipcCode": "G10G7/00",
      "coreCode": "G10G7/00",
      "note": "",

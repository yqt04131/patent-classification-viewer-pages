window.CPC_SHARD_C23D = {
  "generatedAt": "2026-03-20T02:17:57.567Z",
  "total": 25,
  "entries": {
    "C23D": {
      "code": "C23D",
      "level": 5,
      "parent": "C23",
      "ja": "　金属へのほうろう被覆またはガラス質層の形成（ほうろうの化学組成Ｃ０３Ｃ）｛特記１９７６年６月１６日以降，以下のグループは新しい文献の分類に使用されていない。これらのグループに属する未処理文献はグループＣ２３Ｄ１／００～Ｃ２３Ｄ１１／００へ継続的に再分類されている:Ｃ２３Ｄ３／００ＺＣ２３Ｄ５(ＥＣＬＡ)／００Ｚ～Ｃ２３Ｄ５／００Ｚ５Ｃ２３Ｄ９(ＥＣＬＡ)／００Ｚ｝｛注．このサブクラスにおいては，２００４年９月１日以降の新規文献は，改正されたＥＣＬＡ分類手順に従って分類する。すなわち，重要な（発明に関連した）情報にはＥＣＬＡ分類記号，例．Ｃ２３Ｄ１／０２，を付与する。他の（二次）情報には，ＩＣＯ分類記号，例．Ｃ２３Ｄ１／０２，を付与する。｝",
      "en": "ENAMELLING OF, OR APPLYING A VITREOUS LAYER TO, METALS",
      "count": 0,
      "ipcCode": "",
      "coreCode": "",
      "note": "",
    ...
    "C23D1/00": {
      ...
      "level": 7,
      "parent": null,
      "ja": "ほうろうの溶融またはフリッティング；そのための装置または炉",
      "en": "Melting or fritting the enamels; Apparatus or furnaces therefor",
      "count": 38,
      "ipcCode": "C23D1/00",
      "coreCode": "C23D1/00",
      "note": "",
      "sourceFile": "cpc_C23D.txt",
      "kind": "cpc"
    },
    "C23D1/02": {
      "code": "C23D1/02",
      ...
      "parent": "C23D1/00",
      "ja": "溶解物の粒状化；粒状物の乾燥",
      "en": "Granulating the melt; Drying the granules",
      "count": 16,
      "ipcCode": "C23D1/02",
      "coreCode": "C23D1/02",
      "note": "",
    ...
    "C23D3/00": {
      ...
      "level": 7,
      "parent": null,
      "ja": "被覆の前の金属表面の化学処理（金属質物品の洗浄および脱脂Ｃ２３Ｇ）",
      "en": "Chemical treatment of the metal surfaces prior to coating",
      "count": 455,
      "ipcCode": "C23D3/00",
      "coreCode": "C23D3/00",
      "note": "",
    ...
    "C23D5/00": {
      ...
      "level": 7,
      "parent": null,
      "ja": "溶解した耐火物層の適用を含むほうろう被覆またはガラス質層被覆　｛溶解した耐火物層の適用を含むもの:　現在この分類は使用していない；　Ｃ２３Ｃ４／１０，　Ｃ２３Ｃ２４／１０の文献｝",
      "en": "Coating with enamels or vitreous layers",
      "count": 1226,
      "ipcCode": "C23D5/00",
      "coreCode": "C23D5/00",
      "note": "",
    ...
    "C23D5/005": {
      ...
      "level": 8,
      "parent": "C23D5/00",
      "ja": "｛特別の対象物に特別に適用される方法によるもの｝",
      "en": "{by a method specially adapted for coating special objects}",
      "count": 214,
      "ipcCode": "C23D5/00",
      "coreCode": "C23D5/00",
      "note": "",
    ...
    "C23D5/06": {
      ...
      "parent": "C23D5/00",
      "ja": "図案または文字の形成",
      "en": "producing designs or letters",
      "count": 254,
      "ipcCode": "C23D5/06",
      "coreCode": "C23D5/06",
      "note": "",
    ...
    "C23D5/08": {
      ...
      "parent": "C23D5/00",
      "ja": "ほうろうの不均一被覆",
      "en": "Applying enamels non-uniformly over the surface",
      "count": 65,
      "ipcCode": "C23D5/08",
      "coreCode": "C23D5/08",
      "note": "",
    ...
    "C23D5/10": {
      ...
      "level": 8,
      "parent": "C23D5/00",
      "ja": "耐火性物質によるもの．｛注．．[Ｃ０４０９｝グループＣ２３Ｄ５／１０は分類には使用されていない。文献は，Ｃ２３Ｃ４／１０およびＣ２３Ｃ２４／１０に継続的に再分類されている。｝",
      "en": "{with refractory materials}<br><br><u>WARNING</u><br> Group C23D5/10 is no longer used for classification. Documents are in the state of being reclassified to C23C4/10 and C23C24/10. ",
      "count": 105,
      "ipcCode": "C23D5/00",
      "coreCode": "C23D5/10",
      "note": "",
    ...
    "C23D7/00": {
      ...
      "parent": null,
      "ja": "被覆層の処理，例．焼付け前の乾燥",
      "en": "Treating the coatings, e.g. drying before burning",
      "count": 134,
      "ipcCode": "C23D7/00",
      "coreCode": "C23D7/00",
      "note": "",
    ...
    "C23D9/00": {
      ...
      "parent": null,
      "ja": "ほうろう焼付け用窯",
      "en": "Ovens specially adapted for firing enamels",
      "count": 259,
      "ipcCode": "C23D9/00",
      "coreCode": "C23D9/00",
      "note": "",
    ...
    "C23D9/02": {
      ...
      "parent": "C23D9/00",
      "ja": "電熱を用いないマッフル炉",
      "en": "Non-electric muffle furnaces",
      "count": 22,
      "ipcCode": "C23D9/02",
      "coreCode": "C23D9/02",
      "note": "",
    ...
    "C23D9/08": {
      ...
      "parent": "C23D9/00",
      "ja": "燃焼棒の支持装置",
      "en": "Supporting devices for burning-bars",
      "count": 42,
      "ipcCode": "C23D9/08",
      "coreCode": "C23D9/08",
      "note": "",
    ...
    "C23D9/10": {
      ...
      "parent": "C23D9/00",
      "ja": "負荷または非負荷装置",
      "en": "Loading or unloading devices",
      "count": 51,
      "ipcCode": "C23D9/10",
      "coreCode": "C23D9/10",
      "note": "",
    ...
    "C23D11/00": {
      ...
      "parent": null,
      "ja": "連続焼付け法；そのための装置",
      "en": "Continuous processes; Apparatus therefor",
      "count": 216,
      "ipcCode": "C23D11/00",
      "coreCode": "C23D11/00",
      "note": "",
    ...
    "C23D13/00": {
      ...
      "parent": null,
      "ja": "ほうろう被覆部品の後処理",
      "en": "After-treatment of the enamelled articles",
      "count": 142,
      "ipcCode": "C23D13/00",
      "coreCode": "C23D13/00",
      "note": "",
    ...
    "C23D13/02": {
      ...
      "level": 8,
      "parent": "C23D13/00",
      "ja": "ほうろう被覆部の部分的再溶融による欠陥の除去；形状の調整",
      "en": "Removing defects by local re-melting of the enamel; Adjusting the shape",
      "count": 19,
      "ipcCode": "C23D13/02",
      "coreCode": "C23D13/02",
      "note": "",
    ...
    "C23D15/00": {
      ...
      "level": 7,
      "parent": null,
      "ja": "ほうろう被覆段階を含むほうろう被覆部品同志の接合",
      "en": "Joining enamelled articles to other enamelled articles by processes involving an enamelling step",
      "count": 22,
      "ipcCode": "C23D15/00",
      "coreCode": "C23D15/00",
      "note": "",

window.IPC_SHARD_C06C = {
  "generatedAt": "2026-03-20T02:17:46.403Z",
  "total": 11,
  "entries": {
    "C06C": {
      "code": "C06C",
      "level": 0,
      "parent": "C06",
      "ja": "起爆装置または点火装置；導火線；化学的点火具；自然発火剤［２］",
      "en": "DETONATING OR PRIMING DEVICES; FUSES; CHEMICAL LIGHTERS; PYROPHORIC COMPOSITIONS",
      "count": 217,
    ...
    "C06C15/00": {
      ...
      "en": "Pyrophoric compositions; Flints(chemical lighters <b>C06C9/00</b>)",
      "count": 660,
      "sourceFile": "ipc_C06C.txt",
      "kind": "ipc"
    }

window.CPC_SHARD_C09H = {
  "generatedAt": "2026-03-20T02:17:57.376Z",
  "total": 14,
  "entries": {
    "C09H": {
      "code": "C09H",
      ...
      "parent": "C09",
      "ja": "にかわまたはゼラチンの製造",
      "en": "PREPARATION OF GLUE OR GELATINE<br><br><u>WARNING</u><br><br>In this subclass non-limiting references (in the sense of paragraph 39 of the Guide to the IPC) may still be displayed in the scheme.",
      "count": 0,
      "ipcCode": "",
      "coreCode": "",
      "note": "",
    ...
    "C09H1/02": {
      ...
      "parent": "C09H1/00",
      "ja": "骨の前処理（骨の脱脂Ｃ１１Ｂ）",
      "en": "of bones (defatting bones C11B)",
      "count": 73,
      "ipcCode": "C09H1/02",
      "coreCode": "C09H1/02",
      "note": "",
    ...
    "C09H1/04": {
      ...
      "level": 8,
      "parent": "C09H1/00",
      "ja": "獣皮，ひずめまたは皮革くずの前処理（なめし剤の回収Ｃ１４Ｃ）",
      "en": "of hides, hoofs, or leather scrap (recovery of tanning agents C14C)",
      "count": 164,
      "ipcCode": "C09H1/04",
      "coreCode": "C09H1/04",
      "note": "",
    ...
    "C09H3/00": {
      ...
      "level": 7,
      "parent": null,
      "ja": "にかわまたはゼラチンの原料からの分離，例．抽出によるもの，加熱によるもの（食料用ゼラチンＡ２３Ｊ１／１０）",
      "en": "Isolation of glue or gelatine from raw materials, e.g. by extracting, by heating (gelatine for foodstuffs A23J1/10)",
      "count": 483,
      "ipcCode": "C09H3/00",
      "coreCode": "C09H3/00",
      "note": "",
    ...
    "C09H11/00": {
      ...
      "level": 7,
      "parent": null,
      "ja": "｛ＩＰＣ　４｝　にかわまたはゼラチンに基づく接着剤",
      "en": "{Adhesives based on glue or gelatine}",
      "count": 273,
      "ipcCode": "C09J189/00",
      "coreCode": "C09H11/00",
      "note": "",

window.IPC_SHARD_H05C = {
  "generatedAt": "2026-03-20T02:17:47.317Z",
  "total": 8,
  "entries": {
    "H05C": {
      "code": "H05C",
      "level": 0,
      "parent": "H05",
      "ja": "生物を殺し，気絶させ，囲い，または導くための装置用に特別に設計された電気回路または電気装置（電気的手段によって昆虫を捕獲，あるいは殺除するための定置式装置Ａ０１Ｍ１／２２；昆虫以外の有害な動物を電気的に駆除する装置Ａ０１Ｍ１９／００；電気仕掛わなＡ０１Ｍ２３／３８；電流による屠殺または気絶Ａ２２Ｂ３／０６）",
      "en": "ELECTRIC CIRCUITS OR APPARATUS SPECIALLY DESIGNED FOR USE IN EQUIPMENT FOR KILLING, STUNNING, ENCLOSING OR GUIDING LIVING BEINGS(stationary means for catching or killing insects by electric means <b>A01M1/22</b>; apparatus for the destruction of noxious animals, other than insects, by electricity <b>A01M19/00</b>; electric traps for animals <b>A01M23/38</b>; slaughtering or stunning by electric current <b>A22B3/06</b>)",
      "count": 137,
    ...
    "H05C1/00": {
      ...
      "level": 0,
      "parent": "H05C",
      "ja": "電撃効果を生じるための回路または装置",
      "en": "Circuits or apparatus for generating electric shock effects",
      "count": 1013,
      "sourceFile": "ipc_H05C.txt",
      "kind": "ipc"
    },
    "H05C1/02": {
      "code": "H05C1/02",
      "level": 1,
      "parent": "H05C1/00",
      "ja": "直流または交流電圧の連続的な供給を行なうもの",
      "en": "providing continuous feeding of DC or AC voltage",
      "count": 374,
      "sourceFile": "ipc_H05C.txt",
      "kind": "ipc"
    },
    ...
    "H05C1/06": {
      ...
      "parent": "H05C1/04",
      "ja": "接触時のみ作動するもの",
      "en": "operating only when touched",
      "count": 259,
      "sourceFile": "ipc_H05C.txt",
      "kind": "ipc"
    },
    "H05C3/00": {
      ...
      "parent": "H05C",
      "ja": "他の回路または装置",
      "en": "Other circuits or apparatus",
      "count": 409,
      "sourceFile": "ipc_H05C.txt",
      "kind": "ipc"
    }
